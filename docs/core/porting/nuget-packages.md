---
title: "Portabilità in .NET Core - Pacchetti NuGet"
description: "Portabilità in .NET Core - Pacchetti NuGet"
...
# <a name="-porting-to-net-core---nuget-packages"></a>🔧 Portabilità in .NET Core - Pacchetti NuGet
