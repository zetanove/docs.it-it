...
> [!WARNING]
> Questo argomento si applica agli strumenti dell'anteprima 2 di .NET Core. Per gli strumenti di .NET Core versione RC4, vedere l'argomento [Uso di .NET Core SDK e dei relativi strumenti in integrazione continua (strumenti di .NET Core RC4)](../preview3/tools/using-ci-with-cli.md).
