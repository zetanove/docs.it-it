...
Il nome di tipo o di spazio dei nomi 'type/namespace' non è stato trovato. Probabilmente manca una direttiva using o un riferimento all'assembly.  
 ...
 Non è stato trovato un tipo o uno spazio dei nomi usato nel programma. È possibile che non sia stato fatto riferimento ([/reference](../../../csharp/language-reference/compiler-options/reference-compiler-option.md)) all'assembly che contiene il tipo o che non sia stata aggiunta la [direttiva using](../../../csharp/language-reference/keywords/using-directive.md)necessaria.  In alternativa, potrebbe esserci un problema con l'assembly cui si intende fare riferimento.  
