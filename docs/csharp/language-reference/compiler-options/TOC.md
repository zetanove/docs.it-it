...
# [/target:appcontainerexe (creare un file eseguibile Windows)](target-appcontainerexe-compiler-option.md)
...
# [/subsystemversion (specificare la versione minima del sottosistema)](subsystemversion-compiler-option.md)
...
# [/target:winmdobj (creare un file intermedio per Windows Runtime)](target-winmdobj-compiler-option.md)
