...
2.  Nell'elenco **Tipo di output** della scheda **Applicazione**, scegliere **Applicazione Windows Store**.  
     ...
     Questa opzione è disponibile solo per i modelli di app [!INCLUDE[win8_appname_long](../../../csharp/includes/win8-appname-long-md.md)].  
