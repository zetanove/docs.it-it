...
Gli argomenti denominati e gli argomenti facoltativi, introdotti in [!INCLUDE[csharp_dev10_long](../../../csharp/programming-guide/classes-and-structs/includes/csharp-dev10-long-md.md)], migliorano la praticità, la flessibilità e la leggibilità nella programmazione C\#. Queste funzionalità, inoltre, semplificano notevolmente l'accesso alle interfacce COM, quali le API di automazione di Microsoft Office.  
...
1.  Utilizzare il metodo `ConvertToTable` per racchiudere il testo in una tabella.  Il metodo dispone di sedici parametri facoltativi.  IntelliSense racchiude tra parentesi i parametri facoltativi, come mostrato nell'immagine seguente.  
     ...
     ![Elenco di parametri per il metodo ConvertToTable.](../../../csharp/programming-guide/classes-and-structs/media/convert-tableparameters.png "Convert\_TableParameters")  
