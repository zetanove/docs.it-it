---
title: 'Procedura: trovare un elenco di elementi figlio (XPath-LINQ to XML) | Documentazione Microsoft'
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Questo argomento confronta l'asse degli elementi figlio XPath e l'asse [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XContainer.Elements%2A>.  
