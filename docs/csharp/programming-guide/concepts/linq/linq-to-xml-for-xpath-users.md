...
|[Procedura: Trovare un elemento figlio (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-a-child-element-xpath-linq-to-xml.md)|Viene confrontato l'asse degli elementi figlio XPath e il metodo <xref:System.Xml.Linq.XContainer.Element%2A> di [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)].<br /><br /> L'espressione XPath associata è:`"DeliveryNotes"`.|  
|[Procedura: Trovare un elenco di elementi figlio (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-a-list-of-child-elements-xpath-linq-to-xml.md)|Viene confrontato l'asse degli elementi figlio XPath e l'asse <xref:System.Xml.Linq.XContainer.Elements%2A> di [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)].<br /><br /> L'espressione XPath associata è:`"./*"`.|  
...
|[Procedura: Trovare elementi in uno spazio dei nomi (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-elements-in-a-namespace-xpath-linq-to-xml.md)|Viene confrontato l'uso della classe XPath <xref:System.Xml.XmlNamespaceManager> con la proprietà [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XName.Namespace%2A> della classe <xref:System.Xml.Linq.XName> per usare gli spazi dei nomi XML.<br /><br /> L'espressione XPath associata è:`"./aw:*"`.|  
|[Procedura: Trovare elementi di pari livello precedenti (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md)|Viene confrontato l'asse XPath `preceding-sibling` con l'asse [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XNode.ElementsBeforeSelf%2A?displayProperty=fullName> figlio.<br /><br /> L'espressione XPath associata è:`"preceding-sibling::*"`.|  
