...
helpviewer_keywords: 
  ...
  - "programmazione a 64 bit [C++]"
  - "applicazioni [C++], 64 bit"
...
## Confronto tra l'esecuzione di applicazioni a 32 bit ea 64 bit in Windows  
...
-   Codice che esegue il cast di `IntPtr` a `Int32`.  
 ...
 Per altre informazioni su come convertire un'applicazione a 32 bit per eseguirla in CLR a 64 bit, vedere la pagina relativa alla [migrazione del codice gestito da 32 bit a 64 bit](http://go.microsoft.com/fwlink/?LinkId=150542) in MSDN Library.  
...
-   Nella documentazione di [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)] vedere [Guida alla programmazione per Windows a 64 bit](http://go.microsoft.com/fwlink/p/?LinkId=253512).  
...
-   Per informazioni sul supporto di Visual Studio per la creazione di applicazioni a 64 bit, vedere [Supporto a 64 bit per IDE di Visual Studio](../Topic/Visual%20Studio%20IDE%2064-Bit%20Support.md).  
