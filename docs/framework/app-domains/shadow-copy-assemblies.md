---
title: "Creazione di copie replicate di assembly | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "domini applicazione, creazione di copie shadow di assembly"
  - "assembly [.NET Framework], creazione di copie shadow"
  - "creazione di copie shadow di assembly"
...
-   [Abilitazione e uso della creazione di copie shadow](#EnablingAndUsing) descrive l'uso di base e le opzioni disponibili per la copia shadow.  
  
-   [Prestazioni di avvio](#StartupPerformance) descrive le modifiche che vengono apportate alla copia shadow in [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)] per migliorare le prestazioni di avvio e come ripristinare il funzionamento delle versioni precedenti.  
  
-   [Metodi obsoleti](#ObsoleteMethods) descrive le modifiche apportate ai metodi e alle proprietà che controllano la copia shadow in [!INCLUDE[dnprdnlong](../../../includes/dnprdnlong-md.md)].  
  
<a name="EnablingAndUsing"></a>   
## Abilitazione e uso della creazione di copie shadow  
