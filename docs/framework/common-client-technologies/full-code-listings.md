...
---
# Full Code Listings
In questo argomento è contenuto l'intero listato di codice per un'applicazione che utilizza processori di [Manipulations and Inertia](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md).  
  
## Classe GamePiece  
 Nel codice riportato di seguito viene illustrata l'intera classe **GamePiece**.  
...
## Classe GamePieceCollection  
 Nel codice riportato di seguito viene illustrata l'intera classe **GamePieceCollection**.  
...
## Classe Game1  
 Nel codice riportato di seguito viene illustrata l'intera classe **Game1**.  
