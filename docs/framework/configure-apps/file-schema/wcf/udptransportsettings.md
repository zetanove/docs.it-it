...
Questo elemento di configurazione espone le impostazioni del trasporto UDP per [\<udpDiscoveryEndpoint\>](../../../../../docs/framework/configure-apps/file-schema/wcf/udpdiscoveryendpoint.md).  
