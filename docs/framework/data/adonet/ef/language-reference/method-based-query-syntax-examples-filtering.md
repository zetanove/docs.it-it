---
title: "Esempi di sintassi delle query basate su metodo: filtro | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Esempi di sintassi delle query basate su metodo: filtro
Negli esempi inclusi in questo argomento viene illustrato come usare i metodi `Where` e `Where…Contains` per eseguire query sul [modello Sales di AdventureWorks](http://msdn.microsoft.com/it-it/f16cd988-673f-4376-b034-129ca93c7832) usando la sintassi delle query basate su metodo.  Si tenga presente che Where…`Contains` non può essere usato come parte di una [query compilata](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md).  
