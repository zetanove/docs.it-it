---
title: "Compatibilità delle applicazioni in .NET Framework 4.6.2 | Documenti di Microsoft"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="application-compatibility-in-the-net-framework-462"></a>Compatibilità delle applicazioni in .NET Framework 4.6.2
Questo argomento contiene collegamenti a informazioni sui problemi di compatibilità delle applicazioni tra .NET Framework 4.6.1 e 4.6.2. I problemi possono essere suddivisi in due categorie:  
 ...
 Le modifiche di reindirizzamento influiscono sulle app che vengono ricompilate per [!INCLUDE[net_v462](../../../includes/net-v462-md.md)] e che comprendono:  
...
-   Modifiche all'ambiente di runtime. Queste influiscono solo sulle app destinate specificamente a [!INCLUDE[net_v462](../../../includes/net-v462-md.md)]. Le app destinate a versioni precedenti di .NET Framework si comportano come se venissero eseguite in tali versioni.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Elenco delle modifiche di .NET 4.6.2 su GitHub](http://go.microsoft.com/fwlink/?LinkId=708778)
