---
title: "Recupero di risorse nelle applicazioni desktop | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "localizzazione"
  - "controllo delle versioni di assembly satellite"
  - "recupero di risorse localizzate"
  - "risorse dell'applicazione, distribuzione"
  - "creazione di pacchetti di risorse dell'applicazione"
  - "controllo delle versioni di risorse"
  - "conversione di risorse in linguaggi"
...
---
# Recupero di risorse nelle applicazioni desktop
...
## Recupero delle risorse dagli assembly  
...
### Recupero di dati oggetto: due esempi  
...
## Supporto per il controllo delle versioni per gli assembly satellite  
...
<a name="from_file"></a>   
## Recupero di risorse da file .resources  
...
### Distribuzione di file .resources  
...
### Utilizzo del gestore di risorse  
...
> [!NOTE]
>  Non distribuire applicazioni ASP.NET utilizzando file .resources autonomi. Questo può causare problemi di blocco e interrompere la distribuzione XCOPY. Si consiglia di distribuire le risorse ASP.NET in assembly satellite. Per altre informazioni, vedere [ASP.NET Web Page Resources Overview](../Topic/ASP.NET%20Web%20Page%20Resources%20Overview.md).  
