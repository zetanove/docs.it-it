...
|**\/i:** *module*|Specifica i moduli contenenti i componenti elencati nel file **\/complist**.  Per specificare più moduli, usare più flag **\/i**.|  
...
## Esempio di file di risposta  
 Nell'elenco seguente è riportato un esempio di file di risposta, `response.rsp`.  Per altre informazioni sui file di risposta, vedere [Response Files](../Topic/MSBuild%20Response%20Files.md).  
...
```  
 ...
 La seguente riga di comando usa il file il `response.rsp`.  
