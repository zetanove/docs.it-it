...
|Visualizzazione controlli|Visualizzazione contenuto|  
|-------------------------------|-------------------------------|  
|Spinner<br /><br /> -   Edit \(0 o 1\)<br />-   Button \(2\)<br />-   ListItem \(0 o più\)|Spinner<br /><br /> -   ListItem \(0 o più\)|  
