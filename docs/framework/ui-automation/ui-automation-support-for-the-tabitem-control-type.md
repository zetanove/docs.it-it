...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControllerForProperty>|Vedere le note.|Questa proprietà può essere usata come puntatore al riquadro schede associato. Ciò risulta utile nel caso in cui non possa ospitare un riquadro come figlio dell'oggetto voce di scheda.|  
