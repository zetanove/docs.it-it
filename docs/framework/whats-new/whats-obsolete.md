...
ms.topic: "article"
helpviewer_keywords: 
  - "deprecato [.NET Framework]"
  - "obsoleto [.NET Framework]"
  - "contenuto obsoleto [.NET Framework]"
...
---
# Elementi obsoleti nella libreria di classi .NET Framework
...
|4.5 \(inclusi 4.5.1 e altre versioni intermedie\)|v4.0|  
|4|v4.0|  
|3.5|v2.0.50727|  
|2.0|v2.0.50727|  
|1.1|v1.1.4322|  
...
## Elenchi obsoleti per .NET Framework 4.5  
...
## Elenchi obsoleti per le versioni precedenti  
 ...
 [Elenco elementi obsoleti in .NET Framework 3.5](http://go.microsoft.com/fwlink/?LinkId=163710)  
  
 [Elenco elementi obsoleti in .NET Framework 2.0](http://go.microsoft.com/fwlink/?LinkID=125264)  
