---
title: "Procedura: impostare il renderer ToolStrip in fase di esecuzione | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "ToolStripManager (classe) [Windows Form]"
...
---
# Procedura: impostare il renderer ToolStrip in fase di esecuzione
...
## Esempio  
 ...
 Per usare questo esempio di codice, compilare ed eseguire l'applicazione, quindi scegliere **Change Colors** per applicare le sfumature definite nella classe personalizzata `ProfessionalColorTable`.  
...
## Definizione di una classe ProfessionalColorTable personalizzata  
...
## Assegnazione di un renderer personalizzato  
 Creare un nuovo oggetto `ToolStripProfessionalRenderer` con la classe `CustomProfessionalColors` e assegnarlo alla proprietà <xref:System.Windows.Forms.ToolStripManager.Renderer%2A?displayProperty=fullName>.  
