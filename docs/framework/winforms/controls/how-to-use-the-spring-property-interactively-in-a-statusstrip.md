---
title: "Procedura: utilizzare la propriet&#224; Spring in modo interattivo in StatusStrip | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "Spring (proprietà) [Windows Form]"
  - "barre di stato, esempi"
...
## Esempio  
 ...
 Per usare questo esempio di codice, compilare ed eseguire l'applicazione e quindi fare clic su **Middle \(Spring\)** nel controllo <xref:System.Windows.Forms.StatusStrip> per cambiare il valore della proprietà <xref:System.Windows.Forms.ToolStripStatusLabel.Spring%2A>.  
