---
title: "Libreria di controlli | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Libreria di controlli
La libreria di controlli [!INCLUDE[TLA#tla_wpf](../../../../includes/tlasharptla-wpf-md.md)] contiene informazioni sui controlli forniti da [!INCLUDE[TLA#tla_wpf](../../../../includes/tlasharptla-wpf-md.md)], elencate in ordine alfabetico.  
...
## In questa sezione  
 ...
 [Barra multifunzione \(WPF\)](../Topic/Ribbon%20\(WPF\).md)  
 ...
 [Descrizione comando](../../../../docs/framework/wpf/controls/tooltip.md)  
