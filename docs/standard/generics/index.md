...
ms.topic: "article"
helpviewer_keywords: 
  - "metodi generici, inferenza del tipo"
  - "generics [.NET Framework], raccolte"
  - "interfacce generiche [.NET Framework]"
  - "tipi generici costruiti"
  - "tipi generici annidati"
  - "definizioni di tipo generico"
  - "classi generiche [.NET Framework]"
  - "generics [.NET Framework], interfacce"
  - "generics [.NET Framework], informazioni su"
  - "generics [.NET Framework]"
  - "Collection generiche [.NET Framework]"
  - "delegati generici [.NET Framework]"
  - "argomenti tipo generico"
  - "generics [.NET Framework], delegati"
  - "generics [.NET Framework], funzionalità"
  - "vincoli [.NET Framework]"
  - "tipi generici"
...
-   Lo spazio dei nomi <xref:System.Collections.ObjectModel> cataloga tipi di raccolte generiche aggiuntive, come la classe generica <xref:System.Collections.ObjectModel.ReadOnlyCollection%601>, utili per esporre i modelli di oggetto agli utenti delle classi.  
 ...
 Visual C\+\+, C\# e Visual Basic forniscono il supporto completo per la definizione e l'utilizzo dei generics. Per altre informazioni sul supporto dei linguaggi, vedere [Tipi generici in Visual Basic](../Topic/Generic%20Types%20in%20Visual%20Basic%20\(Visual%20Basic\).md), [Introduzione ai generics](../Topic/Introduction%20to%20Generics%20\(C%23%20Programming%20Guide\).md) e [Overview of Generics in Visual C\+\+](../Topic/Overview%20of%20Generics%20in%20Visual%20C++.md).  
...
|[How to: Define a Generic Type with Reflection Emit](../../../docs/framework/reflection-and-codedom/how-to-define-a-generic-type-with-reflection-emit.md)|Viene illustrato come generare assembly dinamici che includono tipi e metodi generici.|  
|[Tipi generici in Visual Basic](../Topic/Generic%20Types%20in%20Visual%20Basic%20\(Visual%20Basic\).md)|Viene descritta la funzionalità generics per gli utenti di Visual Basic, tra cui procedure relative all'utilizzo e alla definizione di tipi generici.|  
|[Introduzione ai generics](../Topic/Introduction%20to%20Generics%20\(C%23%20Programming%20Guide\).md)|Viene fornita una panoramica di definizione e utilizzo di tipi generici per gli utenti di C\#.|  
|[Overview of Generics in Visual C\+\+](../Topic/Overview%20of%20Generics%20in%20Visual%20C++.md)|Viene descritta la funzionalità generics per gli utenti di C\+\+, incluse le differenze tra generics e modelli.|  
