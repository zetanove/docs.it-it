...
### [Ereditarietà in C# e .NET](csharp/tutorials/inheritance.md)
...
### [Uso dell'interpolazione di stringhe](csharp/tutorials/string-interpolation.md)
...
####[Nozioni fondamentali sulle espressioni di query](csharp/linq/query-expression-basics.md)
####[LINQ in C#](csharp/linq/linq-in-csharp.md)
####[Scrivere query LINQ in C#](csharp/linq/write-linq-queries.md)
####[Eseguire query in una raccolta di oggetti](csharp/linq/query-a-collection-of-objects.md)
####[Ottenere una query da un metodo](csharp/linq/return-a-query-from-a-method.md)
####[Archiviare i risultati di una query in memoria](csharp/linq/store-the-results-of-a-query-in-memory.md)
####[Raggruppare i risultati di una query](csharp/linq/group-query-results.md)
####[Creare un gruppo annidato](csharp/linq/create-a-nested-group.md)
####[Eseguire una sottoquery su un'operazione di raggruppamento](csharp/linq/perform-a-subquery-on-a-grouping-operation.md)
####[Raggruppare i risultati per chiavi contigue](csharp/linq/group-results-by-contiguous-keys.md)
####[Specificare dinamicamente i filtri dei predicati in fase di esecuzione](csharp/linq/dynamically-specify-predicate-filters-at-runtime.md)
####[Eseguire inner join](csharp/linq/perform-inner-joins.md)
####[Eseguire join raggruppati](csharp/linq/perform-grouped-joins.md)
####[Eseguire left outer join](csharp/linq/perform-left-outer-joins.md)
####[Ordinare i risultati di una clausola join](csharp/linq/order-the-results-of-a-join-clause.md)
####[Eseguire un join usando una chiave composta](csharp/linq/join-by-using-composite-keys.md)
####[Eseguire operazioni di join personalizzate](csharp/linq/perform-custom-join-operations.md)
####[Gestire valori null nelle espressioni di query](csharp/linq/handle-null-values-in-query-expressions.md)
####[Gestire le eccezioni nelle espressioni di query](csharp/linq/handle-exceptions-in-query-expressions.md)
...
####### [Procedura: combinare e confrontare raccolte di stringhe (LINQ)](csharp/programming-guide/concepts/linq/how-to-combine-and-compare-string-collections-linq.md)
####### [Procedura: popolare raccolte di oggetti da più origini (LINQ)](csharp/programming-guide/concepts/linq/how-to-populate-object-collections-from-multiple-sources-linq.md)
...
####### [Procedura: eseguire una query per trovare il file o i file più grandi in un albero di directory (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-the-largest-file-or-files-in-a-directory-tree-linq.md)
####### [Procedura: eseguire una query per trovare i file duplicati in un albero di directory (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)
...
####### [Panoramica di LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-overview.md)
####### [LINQ to XML e DOM](csharp/programming-guide/concepts/linq/linq-to-xml-vs-dom.md)
...
######## [Panoramica delle classi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-classes-overview.md)
######## [Panoramica della classe XElement](csharp/programming-guide/concepts/linq/xelement-class-overview.md)
######## [Panoramica della classe XAttribute](csharp/programming-guide/concepts/linq/xattribute-class-overview.md)
######## [Panoramica della classe XDocument](csharp/programming-guide/concepts/linq/xdocument-class-overview.md)
######## [Procedura: compilare esempi in LINQ to XML](csharp/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)
####### [Creazione di alberi XML](csharp/programming-guide/concepts/linq/creating-xml-trees.md)
######## [Costruzione funzionale (LINQ to XML)](csharp/programming-guide/concepts/linq/functional-construction-linq-to-xml.md)
######## [Creazione di alberi in C# (LINQ to XML)](csharp/programming-guide/concepts/linq/creating-xml-trees-linq-to-xml-2.md)
######## [Clonazione e collegamento](csharp/programming-guide/concepts/linq/cloning-vs-attaching.md)
######## [Analisi XML](csharp/programming-guide/concepts/linq/parsing-xml.md)
...
######### [Conservazione di spazi vuoti durante il caricamento o l'analisi di dati XML](csharp/programming-guide/concepts/linq/preserving-white-space-while-loading-or-parsing-xml1.md)
######### [Procedura: intercettare gli errori di analisi](csharp/programming-guide/concepts/linq/how-to-catch-parsing-errors.md)
######### [Procedura: Creare un albero da un XmlReader](csharp/programming-guide/concepts/linq/how-to-create-a-tree-from-an-xmlreader.md)
######### [Procedura: flusso di frammenti XML da un XmlReader](csharp/programming-guide/concepts/linq/how-to-stream-xml-fragments-from-an-xmlreader.md)
######## [Procedura: popolare un albero XML con un XmlWriter (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)
...
######## [Panoramica degli spazi dei nomi (LINQ to XML)](csharp/programming-guide/concepts/linq/namespaces-overview-linq-to-xml.md)
...
######## [Procedura: controllare i prefissi dello spazio dei nomi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)
######## [Ambito degli spazi dei nomi predefiniti in C#](csharp/programming-guide/concepts/linq/scope-of-default-namespaces.md)
######## [Procedura: scrivere query in XML negli spazi dei nomi](csharp/programming-guide/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)
####### [Serializzazione di strutture ad albero XML](csharp/programming-guide/concepts/linq/serializing-xml-trees.md)
######## [Conservazione di spazi vuoti durante la serializzazione](csharp/programming-guide/concepts/linq/preserving-white-space-while-serializing.md)
######## [Serializzazione con una dichiarazione XML](csharp/programming-guide/concepts/linq/serializing-with-an-xml-declaration.md)
######## [Serializzazione in base a File, TextWriter e XmlWriter](csharp/programming-guide/concepts/linq/serializing-to-files-textwriters-and-xmlwriters.md)
######## [Serializzazione in base a un XmlReader (richiamo di XSLT)](csharp/programming-guide/concepts/linq/serializing-to-an-xmlreader-invoking-xslt.md)
####### [Assi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-axes.md)
######## [Panoramica degli assi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-axes-overview.md)
...
######## [Procedura. filtrare in base a nomi di elementi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-filter-on-element-names-linq-to-xml.md)
######## [Procedura: concatenare chiamate al metodo axis (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-chain-axis-method-calls-linq-to-xml.md)
...
######### [Procedura: trovare un singolo discendente con il metodo Descendants](csharp/programming-guide/concepts/linq/how-to-find-a-single-descendant-using-the-descendants-method.md)
######### [Procedura: scrivere query con filtro complesso](csharp/programming-guide/concepts/linq/how-to-write-queries-with-complex-filtering.md)
######### [Procedura. filtrare in base a un elemento facoltativo](csharp/programming-guide/concepts/linq/how-to-filter-on-an-optional-element.md)
...
######### [Procedura: ordinare elementi in base a più chiavi](csharp/programming-guide/concepts/linq/how-to-sort-elements-on-multiple-keys.md)
...
######### [Procedura: eseguire il debug di set di risultati di query vuoti](csharp/programming-guide/concepts/linq/how-to-debug-empty-query-results-sets.md)
...
######### [Procedura: utilizzare dizionari in LINQ to XML](csharp/programming-guide/concepts/linq/how-to-work-with-dictionaries-using-linq-to-xml.md)
...
######### [Procedura: proiettare un grafico di oggetti](csharp/programming-guide/concepts/linq/how-to-project-an-object-graph.md)
######### [Procedura: proiettare un tipo anonimo](csharp/programming-guide/concepts/linq/how-to-project-an-anonymous-type.md)
######### [Procedura: generare file di testo da XML](csharp/programming-guide/concepts/linq/how-to-generate-text-files-from-xml.md)
######### [Procedura: generare XML da file CSV](csharp/programming-guide/concepts/linq/how-to-generate-xml-from-csv-files.md)
######## [Tecniche di query avanzate (LINQ to XML)](csharp/programming-guide/concepts/linq/advanced-query-techniques-linq-to-xml.md)
######### [Procedura: unire due raccolte (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-join-two-collections-linq-to-xml.md)
######### [Procedura: creare una gerarchia tramite il raggruppamento](csharp/programming-guide/concepts/linq/how-to-create-hierarchy-using-grouping.md)
######### [Procedura: eseguire una query LINQ to XML tramite XPath](csharp/programming-guide/concepts/linq/how-to-query-linq-to-xml-using-xpath.md)
######### [Procedura: scrivere un metodo axis LINQ to XML](csharp/programming-guide/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)
######### [Procedura: eseguire trasformazioni del flusso di testo in XML](csharp/programming-guide/concepts/linq/how-to-perform-streaming-transformations-of-text-to-xml.md)
...
######## [LINQ to XML per gli utenti di XPath](csharp/programming-guide/concepts/linq/linq-to-xml-for-xpath-users.md)
...
######### [Procedura: filtrare in base a un attributo (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-filter-on-an-attribute-xpath-linq-to-xml.md)
######### [Procedura: trovare elementi correlati (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-related-elements-xpath-linq-to-xml.md)
######### [Procedura: trovare elementi in uno spazio dei nomi (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-elements-in-a-namespace-xpath-linq-to-xml.md)
######### [Procedura: trovare elementi di pari livello precedenti (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md)
...
######### [Procedura: trovare un'unione di due percorsi (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-union-of-two-location-paths-xpath-linq-to-xml.md)
...
########## [Concatenamento di operatori query standard](csharp/programming-guide/concepts/linq/chaining-standard-query-operators-together.md)
######### [Esercitazione: manipolazione di contenuto in un documento WordprocessingML](csharp/programming-guide/concepts/linq/tutorial-manipulating-content-in-a-wordprocessingml-document.md)
...
########## [Ricerca dello stile di paragrafo predefinito](csharp/programming-guide/concepts/linq/finding-the-default-paragraph-style.md)
...
########## [Refactoring tramite un metodo di estensione](csharp/programming-guide/concepts/linq/refactoring-using-an-extension-method.md)
########## [Refactoring tramite una funzione pura](csharp/programming-guide/concepts/linq/refactoring-using-a-pure-function.md)
########## [Proiezione di XML in una forma diversa](csharp/programming-guide/concepts/linq/projecting-xml-in-a-different-shape.md)
########## [Ricerca di testo nei documenti di Word](csharp/programming-guide/concepts/linq/finding-text-in-word-documents.md)
...
########### [Parte relativa allo stile di un documento WordprocessingML](csharp/programming-guide/concepts/linq/style-part-of-a-wordprocessingml-document.md)
########### [Esempio che genera parti di documento Office Open XML](csharp/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)
####### [Modifica degli alberi XML (LINQ to XML)](csharp/programming-guide/concepts/linq/modifying-xml-trees-linq-to-xml.md)
...
######## [Annotazioni LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-annotations.md)
######## [Eventi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-events.md)
######## [Programmazione con nodi](csharp/programming-guide/concepts/linq/programming-with-nodes.md)
######## [Bug nel codice dichiarativo/imperativo misto (LINQ to XML)](csharp/programming-guide/concepts/linq/mixed-declarative-code-imperative-code-bugs-linq-to-xml.md)
######## [Procedura: flusso di frammenti XML con accesso a informazioni di intestazione](csharp/programming-guide/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)
######## [Procedura: eseguire la trasformazione del flusso di documenti XML di grandi dimensioni](csharp/programming-guide/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)
...
######## [Serializzazione dei grafici di oggetti contenenti oggetti XElement](csharp/programming-guide/concepts/linq/serializing-object-graphs-that-contain-xelement-objects.md)
######### [Procedura: serializzare mediante XmlSerializer](csharp/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)
######### [Procedura: serializzare mediante DataContractSerializer](csharp/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)
...
######## [File XML di esempio: tipico ordine di acquisto (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml-1.md)
######## [File XML di esempio: tipico ordine di acquisto in uno spazio dei nomi](csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)
######## [File XML di esempio: più ordini di acquisto (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md)
######## [File XML di esempio: più ordini di acquisto in uno spazio dei nomi](csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-in-a-namespace.md)
######## [File XML di esempio: configurazione di test (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-linq-to-xml.md)
######## [File XML di esempio: configurazione di test in uno spazio dei nomi](csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-in-a-namespace1.md)
######## [File XML di esempio: clienti e ordini (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-linq-to-xml-2.md)
######## [File XSD di esempio: clienti e ordini](csharp/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders1.md)
######## [File XML di esempio: clienti e ordini in uno spazio dei nomi](csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)
######## [File XML di esempio: dati numerici (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-linq-to-xml.md)
######## [File XML di esempio: dati numerici in uno spazio dei nomi](csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-in-a-namespace.md)
######## [File XML di esempio: libri (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-books-linq-to-xml.md)
######## [File XML di esempio: ordini di acquisto consolidati](csharp/programming-guide/concepts/linq/sample-xml-file-consolidated-purchase-orders.md)
...
####### [Operazioni aritmetiche sui puntatori](csharp/programming-guide/unsafe-code-pointers/arithmetic-operations-on-pointers.md)
...
#### [Operatore []](csharp/language-reference/operators/index-operator.md)
...
#### [Operatore -](csharp/language-reference/operators/subtraction-operator.md)
#### [Operatore *](csharp/language-reference/operators/multiplication-operator.md)
#### [Operatore /](csharp/language-reference/operators/division-operator.md)
...
#### [Operatore -=](csharp/language-reference/operators/subtraction-assignment-operator.md)
#### [Operatore *=](csharp/language-reference/operators/multiplication-assignment-operator.md)
#### [Operatore /=](csharp/language-reference/operators/division-assignment-operator.md)
...
####### [Procedura: combinare e confrontare raccolte di stringhe (LINQ)](visual-basic/programming-guide/concepts/linq/how-to-combine-and-compare-string-collections-linq.md)
####### [Procedura: popolare raccolte di oggetti da più origini (LINQ)](visual-basic/programming-guide/concepts/linq/how-to-populate-object-collections-from-multiple-sources-linq.md)
...
####### [Procedura: eseguire una query per trovare il file o i file più grandi in un albero di directory (LINQ)](visual-basic/programming-guide/concepts/linq/how-to-query-for-the-largest-file-or-files-in-a-directory-tree.md)
####### [Procedura: eseguire una query per trovare i file duplicati in un albero di directory (LINQ)](visual-basic/programming-guide/concepts/linq/how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)
...
####### [Panoramica di LINQ to XML](visual-basic/programming-guide/concepts/linq/linq-to-xml-overview.md)
####### [LINQ to XML e DOM](visual-basic/programming-guide/concepts/linq/linq-to-xml-vs-dom.md)
...
######## [Panoramica delle classi LINQ to XML](visual-basic/programming-guide/concepts/linq/linq-to-xml-classes-overview.md)
######## [Panoramica della classe XElement](visual-basic/programming-guide/concepts/linq/xelement-class-overview.md)
######## [Panoramica della classe XAttribute](visual-basic/programming-guide/concepts/linq/xattribute-class-overview.md)
######## [Panoramica della classe XDocument](visual-basic/programming-guide/concepts/linq/xdocument-class-overview.md)
######## [Procedura: compilare esempi in LINQ to XML](visual-basic/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)
####### [Creazione di alberi XML](visual-basic/programming-guide/concepts/linq/creating-xml-trees.md)
...
######## [Clonazione e collegamento](visual-basic/programming-guide/concepts/linq/cloning-vs-attaching.md)
######## [Analisi XML](visual-basic/programming-guide/concepts/linq/parsing-xml.md)
...
######### [Conservazione di spazi vuoti durante il caricamento o l'analisi di dati XML](visual-basic/programming-guide/concepts/linq/preserving-white-space-while-loading-or-parsing-xml.md)
######### [Procedura: intercettare gli errori di analisi](visual-basic/programming-guide/concepts/linq/how-to-catch-parsing-errors.md)
######### [Procedura: creare un albero da un XmlReader](visual-basic/programming-guide/concepts/linq/how-to-create-a-tree-from-an-xmlreader.md)
######### [Procedura: flusso di frammenti XML da un XmlReader](visual-basic/programming-guide/concepts/linq/how-to-stream-xml-fragments-from-an-xmlreader.md)
######## [Procedura: popolare un albero XML con un XmlWriter (LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)
...
######## [Panoramica degli spazi dei nomi (LINQ to XML)](visual-basic/programming-guide/concepts/linq/namespaces-overview-linq-to-xml.md)
...
######## [Procedura: controllare i prefissi dello spazio dei nomi (LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)
######## [Ambito degli spazi dei nomi predefiniti](visual-basic/programming-guide/concepts/linq/scope-of-default-namespaces.md)
######## [Utilizzo degli spazi dei nomi globali (LINQ to XML)](visual-basic/programming-guide/concepts/linq/working-with-global-namespaces-linq-to-xml.md)
######## [Spazi dei nomi (LINQ to XML)](visual-basic/programming-guide/concepts/linq/namespaces-linq-to-xml.md)
######## [Procedura: scrivere query in XML negli spazi dei nomi](visual-basic/programming-guide/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)
####### [Serializzazione di strutture ad albero XML](visual-basic/programming-guide/concepts/linq/serializing-xml-trees.md)
######## [Conservazione di spazi vuoti durante la serializzazione](visual-basic/programming-guide/concepts/linq/preserving-white-space-while-serializing.md)
...
######## [Serializzazione in base a File, TextWriter e XmlWriter](visual-basic/programming-guide/concepts/linq/serializing-to-files-textwriters-and-xmlwriters.md)
######## [Serializzazione in base a un XmlReader (richiamo di XSLT)](visual-basic/programming-guide/concepts/linq/serializing-to-an-xmlreader-invoking-xslt.md)
####### [Assi LINQ to XML](visual-basic/programming-guide/concepts/linq/linq-to-xml-axes.md)
######## [Panoramica degli assi LINQ to XML](visual-basic/programming-guide/concepts/linq/linq-to-xml-axes-overview.md)
...
######## [Procedura. filtrare in base a nomi di elementi (LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-filter-on-element-names-linq-to-xml.md)
######## [Procedura: concatenare chiamate al metodo axis (LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-chain-axis-method-calls-linq-to-xml.md)
...
######## [Procedura: recuperare il valore superficiale di un elemento](visual-basic/programming-guide/concepts/linq/how-to-retrieve-the-shallow-value-of-an-element.md)
...
######### [Procedura: trovare un singolo discendente con il metodo Descendants](visual-basic/programming-guide/concepts/linq/how-to-find-a-single-descendant-using-the-descendants-method.md)
######### [Procedura: scrivere query con filtro complesso](visual-basic/programming-guide/concepts/linq/how-to-write-queries-with-complex-filtering.md)
######### [Procedura. filtrare in base a un elemento facoltativo](visual-basic/programming-guide/concepts/linq/how-to-filter-on-an-optional-element.md)
...
######### [Procedura: ordinare elementi in base a più chiavi](visual-basic/programming-guide/concepts/linq/how-to-sort-elements-on-multiple-keys.md)
...
######### [Procedura: eseguire il debug di set di risultati di query vuoti](visual-basic/programming-guide/concepts/linq/how-to-debug-empty-query-results-sets.md)
...
######### [Procedura: utilizzare dizionari in LINQ to XML](visual-basic/programming-guide/concepts/linq/how-to-work-with-dictionaries-using-linq-to-xml.md)
...
######### [Procedura: controllare il tipo di una proiezione](visual-basic/programming-guide/concepts/linq/how-to-control-the-type-of-a-projection.md)
...
######### [Procedura: proiettare un grafico di oggetti](visual-basic/programming-guide/concepts/linq/how-to-project-an-object-graph.md)
######### [Procedura: proiettare un tipo anonimo](visual-basic/programming-guide/concepts/linq/how-to-project-an-anonymous-type.md)
######### [Procedura: generare file di testo da XML](visual-basic/programming-guide/concepts/linq/how-to-generate-text-files-from-xml.md)
...
######### [Procedura: unire due raccolte (LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-join-two-collections-linq-to-xml.md)
######### [Procedura: creare una gerarchia tramite il raggruppamento](visual-basic/programming-guide/concepts/linq/how-to-create-hierarchy-using-grouping.md)
######### [Procedura: eseguire una query LINQ to XML tramite XPath](visual-basic/programming-guide/concepts/linq/how-to-query-linq-to-xml-using-xpath.md)
######### [Procedura: scrivere un metodo axis LINQ to XML](visual-basic/programming-guide/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)
...
######## [LINQ to XML per gli utenti di XPath](visual-basic/programming-guide/concepts/linq/linq-to-xml-for-xpath-users.md)
...
######### [Procedura: filtrare in base a un attributo (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-filter-on-an-attribute-xpath-linq-to-xml.md)
######### [Procedura: trovare elementi correlati (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-related-elements-xpath-linq-to-xml.md)
######### [Procedura: trovare elementi in uno spazio dei nomi (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-elements-in-a-namespace.md)
######### [Procedura: trovare elementi di pari livello precedenti (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md)
...
######### [Procedura: trovare un'unione di due percorsi (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-a-union-of-two-location-paths-xpath.md)
...
######### [Esercitazione: manipolazione di contenuto in un documento WordprocessingML](visual-basic/programming-guide/concepts/linq/tutorial-manipulating-content-in-a-wordprocessingml-document.md)
...
########## [Ricerca dello stile di paragrafo predefinito](visual-basic/programming-guide/concepts/linq/finding-the-default-paragraph-style.md)
...
########## [Refactoring tramite un metodo di estensione](visual-basic/programming-guide/concepts/linq/refactoring-using-an-extension-method.md)
########## [Refactoring tramite una funzione pura](visual-basic/programming-guide/concepts/linq/refactoring-using-a-pure-function.md)
########## [Proiezione di XML in una forma diversa](visual-basic/programming-guide/concepts/linq/projecting-xml-in-a-different-shape.md)
########## [Ricerca di testo nei documenti di Word](visual-basic/programming-guide/concepts/linq/finding-text-in-word-documents.md)
########## [Dettagli di documenti WordprocessingML Office Open XML](visual-basic/programming-guide/concepts/linq/details-of-office-open-xml-wordprocessingml-documents.md)
...
########### [Parte relativa allo stile di un documento WordprocessingML](visual-basic/programming-guide/concepts/linq/style-part-of-a-wordprocessingml-document.md)
########### [Esempio che genera parti di documento Office Open XML](visual-basic/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)
####### [Modifica degli alberi XML (LINQ to XML)](visual-basic/programming-guide/concepts/linq/modifying-xml-trees-linq-to-xml.md)
...
######## [Annotazioni LINQ to XML](visual-basic/programming-guide/concepts/linq/linq-to-xml-annotations.md)
######## [Eventi LINQ to XML](visual-basic/programming-guide/concepts/linq/linq-to-xml-events.md)
######## [Programmazione con nodi](visual-basic/programming-guide/concepts/linq/programming-with-nodes.md)
######## [Bug nel codice dichiarativo/imperativo misto (LINQ to XML)](visual-basic/programming-guide/concepts/linq/mixed-declarative-code-imperative-code-bugs-linq-to-xml.md)
######## [Procedura: flusso di frammenti XML con accesso a informazioni di intestazione](visual-basic/programming-guide/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)
######## [Procedura: eseguire la trasformazione del flusso di documenti XML di grandi dimensioni](visual-basic/programming-guide/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)
...
######## [Serializzazione dei grafici di oggetti contenenti oggetti XElement](visual-basic/programming-guide/concepts/linq/serializing-object-graphs-that-contain-xelement-objects.md)
######### [Procedura: serializzare mediante XmlSerializer](visual-basic/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)
######### [Procedura: serializzare mediante DataContractSerializer](visual-basic/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)
...
######### [File XML di esempio: tipico ordine di acquisto (LINQ to XML)](visual-basic/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml.md)
######### [File XML di esempio: tipico ordine di acquisto in uno spazio dei nomi](visual-basic/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)
######### [File XML di esempio: più ordini di acquisto (LINQ to XML)](visual-basic/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md)
######### [File XML di esempio: più ordini di acquisto in uno spazio dei nomi](visual-basic/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-in-a-namespace.md)
...
######### [File XML di esempio: clienti e ordini (LINQ to XML)](visual-basic/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-linq-to-xml.md)
######### [File XSD di esempio: clienti e ordini](visual-basic/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders.md)
######### [File XML di esempio: clienti e ordini in uno spazio dei nomi](visual-basic/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)
...
######### [File XML di esempio: libri (LINQ to XML)](visual-basic/programming-guide/concepts/linq/sample-xml-file-books-linq-to-xml.md)
######### [File XML di esempio: ordini di acquisto consolidati](visual-basic/programming-guide/concepts/linq/sample-xml-file-consolidated-purchase-orders.md)
