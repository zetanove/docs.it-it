...
## [Novità di C#6](csharp/whats-new.md) 
...
### [Interoperabilità nativa](csharp/programming-guide/interop/interoperability.md)
...
#### [Convenzioni di codifica C#](csharp/programming-guide/inside-a-program/coding-conventions.md)
...
##### [Procedura: Definire le costanti in C#](csharp/programming-guide/classes-and-structs/how-to-define-constants.md)
...
##### [Procedura: Dichiarare e usare proprietà Read Write](csharp/programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties.md)
##### [Proprietà implementate automaticamente](csharp/programming-guide/classes-and-structs/auto-implemented-properties.md)
##### [Procedura: Implementare una classe leggera con proprietà implementate automaticamente](csharp/programming-guide/classes-and-structs/how-to-implement-a-lightweight-class-with-auto-implemented-properties.md)
...
###### [Procedura: Implementare e chiamare un metodo di estensione personalizzato](csharp/programming-guide/classes-and-structs/how-to-implement-and-call-a-custom-extension-method.md)
###### [Procedura: Creare un nuovo metodo per un'enumerazione](csharp/programming-guide/classes-and-structs/how-to-create-a-new-method-for-an-enumeration.md)
...
##### [Procedura: Inizializzare oggetti usando un inizializzatore di oggetto](csharp/programming-guide/classes-and-structs/how-to-initialize-objects-by-using-an-object-initializer.md)
##### [Procedura: Inizializzare un dizionario con un inizializzatore di raccolta](csharp/programming-guide/classes-and-structs/how-to-initialize-a-dictionary-with-a-collection-initializer.md)
...
##### [Procedura: Restituire sottoinsiemi di proprietà degli elementi in una query](csharp/programming-guide/classes-and-structs/how-to-return-subsets-of-element-properties-in-a-query.md)
...
#### [Procedura: Combinare delegati multicast (Guida per programmatori C#)](csharp/programming-guide/delegates/how-to-combine-delegates-multicast-delegates.md)
...
#### [Procedura: Gestire un'eccezione usando Try/Catch](csharp/programming-guide/exceptions/how-to-handle-an-exception-using-try-catch.md)
...
#### [Procedura: Intercettare un'eccezione non CLS](csharp/programming-guide/exceptions/how-to-catch-a-non-cls-exception.md)
### [File system e Registro di sistema](csharp/programming-guide/file-system/file-system-and-the-registry.md)
#### [Procedura: Scorrere un albero di directory](csharp/programming-guide/file-system/how-to-iterate-through-a-directory-tree.md)
#### [Procedura: Ottenere informazioni relative a file, cartelle e unità](csharp/programming-guide/file-system/how-to-get-information-about-files-folders-and-drives.md)
#### [Procedura: Creare un file o una cartella](csharp/programming-guide/file-system/how-to-create-a-file-or-folder.md)
...
#### [Procedura: Creare una finestra di dialogo dello stato di avanzamento per operazioni su file](csharp/programming-guide/file-system/how-to-provide-a-progress-dialog-box-for-file-operations.md)
#### [Procedura: Scrivere in un file di testo](csharp/programming-guide/file-system/how-to-write-to-a-text-file.md)
#### [Procedura: Leggere da un file di testo](csharp/programming-guide/file-system/how-to-read-from-a-text-file.md)
#### [Procedura: Leggere un file di testo una riga alla volta (Visual C#)](csharp/programming-guide/file-system/how-to-read-a-text-file-one-line-at-a-time.md)
#### [Procedura: creare una chiave nel Registro di sistema (Visual C#)](csharp/programming-guide/file-system/how-to-create-a-key-in-the-registry.md)
### [Generics](csharp/programming-guide/generics/index.md)
...
#### [Generics e matrici](csharp/programming-guide/generics/generics-and-arrays.md)
#### [Delegati generici](csharp/programming-guide/generics/generic-delegates.md)
#### [Parola chiave default in codice generico](csharp/programming-guide/generics/default-keyword-in-generic-code.md)
...
#### [Generics e attributi](csharp/programming-guide/generics/generics-and-attributes.md)
...
#### [Procedura dettagliata: Programmazione di Office (C# e Visual Basic)](csharp/programming-guide/interop/walkthrough-office-programming.md)
#### [Esempio di classe COM](csharp/programming-guide/interop/example-com-class.md)

### [Espressioni di query LINQ](csharp/programming-guide/linq-query-expressions/index.md)
#### [Nozioni fondamentali sulle espressioni di query](csharp/programming-guide/linq-query-expressions/query-expression-basics.md)
#### [Procedura: Scrivere query LINQ in C#](csharp/programming-guide/linq-query-expressions/how-to-write-linq-queries.md)
#### [Procedura: Eseguire query in una raccolta di oggetti](csharp/programming-guide/linq-query-expressions/how-to-query-a-collection-of-objects.md)
#### [Procedura: Ottenere una query da un metodo](csharp/programming-guide/linq-query-expressions/how-to-return-a-query-from-a-method.md)
#### [Procedura: Archiviare i risultati di una query in memoria](csharp/programming-guide/linq-query-expressions/how-to-store-the-results-of-a-query-in-memory.md)
...
#### [Procedura: Raggruppare i risultati per chiavi contigue](csharp/programming-guide/linq-query-expressions/how-to-group-results-by-contiguous-keys.md)
...
#### [Procedura: Gestire valori null nelle espressioni di query](csharp/programming-guide/linq-query-expressions/how-to-handle-null-values-in-query-expressions.md)
...
#### [Procedura: Eseguire il cast sicuro da bool? a bool](csharp/programming-guide/nullable-types/how-to-safely-cast-from-bool-to-bool.md)
### [Nozioni di base sulla programmazione](csharp/programming-guide/concepts/index.md)
#### [Assembly e Global Assembly Cache](csharp/programming-guide/concepts/assemblies-gac/index.md)
##### [Assembly Friend](csharp/programming-guide/concepts/assemblies-gac/friend-assemblies.md)
###### [Procedura: Creare assembly Friend non firmati](csharp/programming-guide/concepts/assemblies-gac/how-to-create-unsigned-friend-assemblies.md)
...
##### [Procedura: Creare e usare assembly dalla riga di comando](csharp/programming-guide/concepts/assemblies-gac/how-to-create-and-use-assemblies-using-the-command-line.md)
##### [Procedura: Determinare se un file è un assembly](csharp/programming-guide/concepts/assemblies-gac/how-to-determine-if-a-file-is-an-assembly.md)
##### [Procedura: Caricare e scaricare gli assembly](csharp/programming-guide/concepts/assemblies-gac/how-to-load-and-unload-assemblies.md)
##### [Procedura: Condividere un assembly con altre applicazioni](csharp/programming-guide/concepts/assemblies-gac/how-to-share-an-assembly-with-other-applications.md)
##### [Procedura dettagliata: Incorporamento dei tipi da assembly gestiti in Visual Studio](csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-visual-studio.md)
##### [Procedura dettagliata: Incorporamento delle informazioni sui tipi da assembly di Microsoft Office in Visual Studio](csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-type-information-from-microsoft-office-assemblies.md)
#### [Programmazione asincrona con async e await](csharp/programming-guide/concepts/async/asynchronous-programming-with-async-and-await.md)
...
##### [Procedura: Estendere la procedura dettagliata asincrona usando Task.WhenAll](csharp/programming-guide/concepts/async/how-to-extend-the-async-walkthrough-by-using-task-whenall.md)
##### [Procedura: Effettuare più richieste Web in parallelo usando async e await](csharp/programming-guide/concepts/async/how-to-make-multiple-web-requests-in-parallel-by-using-async-and-await.md)
##### [Tipi restituiti asincroni](csharp/programming-guide/concepts/async/async-return-types.md)
##### [Flusso di controllo in programmi asincroni](csharp/programming-guide/concepts/async/control-flow-in-async-programs.md)
##### [Ottimizzazione dell'applicazione Async](csharp/programming-guide/concepts/async/fine-tuning-your-async-application.md)
###### [Annullare un'attività asincrona o un elenco di attività](csharp/programming-guide/concepts/async/cancel-an-async-task-or-a-list-of-tasks.md)
###### [Annullare attività asincrone dopo un periodo di tempo](csharp/programming-guide/concepts/async/cancel-async-tasks-after-a-period-of-time.md)
###### [Annullare le attività asincrone rimanenti dopo che ne è stata completata una](csharp/programming-guide/concepts/async/cancel-remaining-async-tasks-after-one-is-complete.md)
###### [Avviare più attività asincrone ed elaborarle quando vengono completate](csharp/programming-guide/concepts/async/start-multiple-async-tasks-and-process-them-as-they-complete.md)
##### [Gestione della reentrancy nelle applicazioni asincrone](csharp/programming-guide/concepts/async/handling-reentrancy-in-async-apps.md)
##### [Uso della funzionalità Async per l'accesso ai file](csharp/programming-guide/concepts/async/using-async-for-file-access.md)
#### [Attributi](csharp/programming-guide/concepts/attributes/index.md)
##### [Creazione di attributi personalizzati](csharp/programming-guide/concepts/attributes/creating-custom-attributes.md)
###### [AttributeUsage](csharp/programming-guide/concepts/attributes/attributeusage.md)
##### [Accesso agli attributi tramite reflection](csharp/programming-guide/concepts/attributes/accessing-attributes-by-using-reflection.md)
##### [Procedura: Creare un'unione C-C++ con gli attributi](csharp/programming-guide/concepts/attributes/how-to-create-a-c-cpp-union-by-using-attributes.md)
##### [Attributi comuni](csharp/programming-guide/concepts/attributes/common-attributes.md)
#### [Informazioni sul chiamante](csharp/programming-guide/concepts/caller-information.md)
#### [Raccolte](csharp/programming-guide/concepts/collections.md)
#### [Covarianza e controvarianza](csharp/programming-guide/concepts/covariance-contravariance/index.md)
##### [Varianza nelle interfacce generiche](csharp/programming-guide/concepts/covariance-contravariance/variance-in-generic-interfaces.md)
###### [Creazione di interfacce generiche variant](csharp/programming-guide/concepts/covariance-contravariance/creating-variant-generic-interfaces.md)
###### [Uso della varianza nelle interfacce per le raccolte generiche](csharp/programming-guide/concepts/covariance-contravariance/using-variance-in-interfaces-for-generic-collections.md)
...
##### [Procedura: Eseguire alberi delle espressioni](csharp/programming-guide/concepts/expression-trees/how-to-execute-expression-trees.md)
##### [Procedura: Modificare alberi delle espressioni](csharp/programming-guide/concepts/expression-trees/how-to-modify-expression-trees.md)
##### [Procedura: Usare alberi delle espressioni per la compilazione di query dinamiche](csharp/programming-guide/concepts/expression-trees/how-to-use-expression-trees-to-build-dynamic-queries.md)
##### [Debug degli alberi delle espressioni in Visual Studio](csharp/programming-guide/concepts/expression-trees/debugging-expression-trees-in-visual-studio.md)
#### [Iteratori](csharp/programming-guide/concepts/iterators.md)
#### [LINQ (Language-Integrated Query)](csharp/programming-guide/concepts/linq/index.md)
##### [Introduzione a LINQ](csharp/programming-guide/concepts/linq/introduction-to-linq.md)
##### [Nozioni di base su LINQ in C#](csharp/programming-guide/concepts/linq/getting-started-with-linq.md)
###### [Introduzione alle query LINQ](csharp/programming-guide/concepts/linq/introduction-to-linq-queries.md)
###### [LINQ e tipi generici](csharp/programming-guide/concepts/linq/linq-and-generic-types.md)
###### [Operazioni di query LINQ di base](csharp/programming-guide/concepts/linq/basic-linq-query-operations.md)
###### [Trasformazioni dati con LINQ](csharp/programming-guide/concepts/linq/data-transformations-with-linq.md)
...
###### [Procedura dettagliata: Scrittura di query in C# (LINQ)](csharp/programming-guide/concepts/linq/walkthrough-writing-queries-linq.md)
...
###### [Ordinamento dei dati](csharp/programming-guide/concepts/linq/sorting-data.md)
###### [Operazioni sui set](csharp/programming-guide/concepts/linq/set-operations.md)
###### [Filtraggio dei dati](csharp/programming-guide/concepts/linq/filtering-data.md)
###### [Operazioni del quantificatore](csharp/programming-guide/concepts/linq/quantifier-operations.md)
###### [Operazioni di proiezione](csharp/programming-guide/concepts/linq/projection-operations.md)
###### [Partizionamento dei dati](csharp/programming-guide/concepts/linq/partitioning-data.md)
###### [Operazioni di join](csharp/programming-guide/concepts/linq/join-operations.md)
###### [Raggruppamento dei dati](csharp/programming-guide/concepts/linq/grouping-data.md)
###### [Operazioni di generazione](csharp/programming-guide/concepts/linq/generation-operations.md)
###### [Operazioni di uguaglianza](csharp/programming-guide/concepts/linq/equality-operations.md)
###### [Operazioni sugli elementi](csharp/programming-guide/concepts/linq/element-operations.md)
###### [Conversione del tipo di dati](csharp/programming-guide/concepts/linq/converting-data-types.md)
###### [Operazioni di concatenazione](csharp/programming-guide/concepts/linq/concatenation-operations.md)
###### [Operazioni di aggregazione](csharp/programming-guide/concepts/linq/aggregation-operations.md)
##### [LINQ to Objects](csharp/programming-guide/concepts/linq/linq-to-objects.md)
###### [LINQ e stringhe](csharp/programming-guide/concepts/linq/linq-and-strings.md)
####### [Procedura: Contare le occorrenze di una parola in una stringa (LINQ)](csharp/programming-guide/concepts/linq/how-to-count-occurrences-of-a-word-in-a-string-linq.md)
####### [Procedura: Eseguire una query per trovare frasi che contengono un set specificato di parole (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-sentences-that-contain-a-specified-set-of-words-linq.md)
####### [Procedura: Eseguire una query per trovare caratteri in una stringa (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-characters-in-a-string-linq.md)
####### [Procedura: Combinare query LINQ con espressioni regolari](csharp/programming-guide/concepts/linq/how-to-combine-linq-queries-with-regular-expressions.md)
####### [Procedura: Trovare la differenza dei set tra due elenchi (LINQ)](csharp/programming-guide/concepts/linq/how-to-find-the-set-difference-between-two-lists-linq.md)
####### [Procedura: Ordinare o filtrare i dati di testo in base a qualsiasi parola o campo (LINQ)](csharp/programming-guide/concepts/linq/how-to-sort-or-filter-text-data-by-any-word-or-field-linq.md)
####### [Procedura: Riordinare i campi di un file delimitato (LINQ)](csharp/programming-guide/concepts/linq/how-to-reorder-the-fields-of-a-delimited-file-linq.md)
####### [Procedura: Combinare e confrontare insiemi di stringhe (LINQ)](csharp/programming-guide/concepts/linq/how-to-combine-and-compare-string-collections-linq.md)
####### [Procedura: Popolare insiemi di oggetti da più origini (LINQ)](csharp/programming-guide/concepts/linq/how-to-populate-object-collections-from-multiple-sources-linq.md)
####### [Procedura: Suddividere un file in molti file usando i gruppi (LINQ)](csharp/programming-guide/concepts/linq/how-to-split-a-file-into-many-files-by-using-groups-linq.md)
####### [Procedura: Unire contenuto da file dissimili (LINQ)](csharp/programming-guide/concepts/linq/how-to-join-content-from-dissimilar-files-linq.md)
####### [Procedura: Calcolare i valori di colonna in un file di testo CSV (LINQ)](csharp/programming-guide/concepts/linq/how-to-compute-column-values-in-a-csv-text-file-linq.md)
###### [LINQ e Reflection](csharp/programming-guide/concepts/linq/linq-and-reflection.md)
...
####### [Procedura: Eseguire una query per trovare i file con un attributo o un nome specifico](csharp/programming-guide/concepts/linq/how-to-query-for-files-with-a-specified-attribute-or-name.md)
####### [Procedura: Raggruppare i file per estensione (LINQ)](csharp/programming-guide/concepts/linq/how-to-group-files-by-extension-linq.md)
...
####### [Procedura: Confrontare il contenuto di due cartelle (LINQ)](csharp/programming-guide/concepts/linq/how-to-compare-the-contents-of-two-folders-linq.md)
####### [Procedura: Eseguire una query per trovare il file o i file più grandi in una struttura ad albero di directory (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-the-largest-file-or-files-in-a-directory-tree-linq.md)
####### [Procedura: Eseguire una query per trovare i file duplicati in una struttura ad albero di directory (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)
####### [Procedura: Eseguire una query sul contenuto dei file in una cartella (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-the-contents-of-files-in-a-folder-lin.md)
...
###### [Procedura: Aggiungere metodi personalizzati per le query LINQ](csharp/programming-guide/concepts/linq/how-to-add-custom-methods-for-linq-queries.md)
...
####### [Cenni preliminari su LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-overview.md)
####### [Differenze tra LINQ to XML e DOM](csharp/programming-guide/concepts/linq/linq-to-xml-vs-dom.md)
####### [Differenze tra LINQ to XML e altre tecnologie XML](csharp/programming-guide/concepts/linq/linq-to-xml-vs-other-xml-technologies.md)
###### [Guida per programmatori (LINQ to XML)](csharp/programming-guide/concepts/linq/programming-guide-linq-to-xml.md)
####### [Panoramica della programmazione con LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-programming-overview.md)
######## [Programmazione funzionale e programmazione procedurale (LINQ to XML)](csharp/programming-guide/concepts/linq/functional-vs-procedural-programming-linq-to-xml.md)
######## [Cenni preliminari sulle classi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-classes-overview.md)
######## [Cenni preliminari sulla classe XElement](csharp/programming-guide/concepts/linq/xelement-class-overview.md)
######## [Cenni preliminari sulla classe XAttribute](csharp/programming-guide/concepts/linq/xattribute-class-overview.md)
######## [Cenni preliminari sulla classe XDocument](csharp/programming-guide/concepts/linq/xdocument-class-overview.md)
######## [Procedura: Compilare esempi di LINQ to XML](csharp/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)
####### [Creazione di strutture ad albero XML](csharp/programming-guide/concepts/linq/creating-xml-trees.md)
######## [Costruzione funzionale (LINQ to XML)](csharp/programming-guide/concepts/linq/functional-construction-linq-to-xml.md)
######## [Creazione di strutture ad albero XML in C# (LINQ to XML)](csharp/programming-guide/concepts/linq/creating-xml-trees-linq-to-xml-2.md)
######## [Duplicazione e collegamento](csharp/programming-guide/concepts/linq/cloning-vs-attaching.md)
######## [Analisi di XML](csharp/programming-guide/concepts/linq/parsing-xml.md)
######### [Procedura: Analizzare una stringa](csharp/programming-guide/concepts/linq/how-to-parse-a-string.md)
######### [Procedura: Caricare XML da un file](csharp/programming-guide/concepts/linq/how-to-load-xml-from-a-file.md)
######### [Conservazione dello spazio vuoto durante il caricamento o l'analisi XML](csharp/programming-guide/concepts/linq/preserving-white-space-while-loading-or-parsing-xml1.md)
######### [Procedura: Intercettare errori di analisi](csharp/programming-guide/concepts/linq/how-to-catch-parsing-errors.md)
######### [Procedura: Creare una struttura ad albero da un oggetto XmlReader](csharp/programming-guide/concepts/linq/how-to-create-a-tree-from-an-xmlreader.md)
######### [Procedura: Generare un flusso di frammenti XML da un oggetto XmlReader](csharp/programming-guide/concepts/linq/how-to-stream-xml-fragments-from-an-xmlreader.md)
######## [Procedura: Popolare una struttura ad albero XML con XmlWriter (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)
######## [Procedura: Eseguire la convalida tramite XSD (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-validate-using-xsd-linq-to-xml.md)
######## [Contenuto valido di oggetti XElement e XDocument](csharp/programming-guide/concepts/linq/valid-content-of-xelement-and-xdocument-objects3.md)
####### [Utilizzo degli spazi dei nomi XML](csharp/programming-guide/concepts/linq/working-with-xml-namespaces.md)
######## [Cenni preliminari sugli spazi dei nomi (LINQ to XML)](csharp/programming-guide/concepts/linq/namespaces-overview-linq-to-xml.md)
######## [Procedura: Creare un documento con spazi dei nomi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-create-a-document-with-namespaces-linq-to-xml.md)
######## [Procedura: Controllare i prefissi degli spazi dei nomi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)
######## [Ambito degli spazi dei nomi predefiniti in C#](csharp/programming-guide/concepts/linq/scope-of-default-namespaces.md)
######## [Procedura: Scrivere query su XML negli spazi dei nomi](csharp/programming-guide/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)
####### [Serializzazione di strutture ad albero XML](csharp/programming-guide/concepts/linq/serializing-xml-trees.md)
######## [Mantenimento dello spazio vuoto durante la serializzazione](csharp/programming-guide/concepts/linq/preserving-white-space-while-serializing.md)
######## [Serializzazione con una dichiarazione XML](csharp/programming-guide/concepts/linq/serializing-with-an-xml-declaration.md)
######## [Serializzazione in oggetti File, TextWriter e XmlWriter](csharp/programming-guide/concepts/linq/serializing-to-files-textwriters-and-xmlwriters.md)
######## [Serializzazione in XmlReader (chiamata di XSLT)](csharp/programming-guide/concepts/linq/serializing-to-an-xmlreader-invoking-xslt.md)
####### [Assi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-axes.md)
######## [Cenni preliminari sugli assi di LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-axes-overview.md)
######## [Procedura: Recuperare una raccolta di elementi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-collection-of-elements-linq-to-xml.md)
######## [Procedura: Recuperare il valore di un elemento (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-the-value-of-an-element-linq-to-xml.md)
######## [Procedura: Applicare un filtro in base a nomi di elemento (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-filter-on-element-names-linq-to-xml.md)
######## [Procedura: Concatenare chiamate ai metodi degli assi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-chain-axis-method-calls-linq-to-xml.md)
######## [Procedura: Recuperare un singolo elemento figlio (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-single-child-element-linq-to-xml.md)
######## [Procedura: Recuperare una raccolta di attributi (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-collection-of-attributes-linq-to-xml.md)
######## [Procedura: Recuperare un singolo attributo (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-single-attribute-linq-to-xml.md)
######## [Procedura: Recuperare il valore di un attributo (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-the-value-of-an-attribute-linq-to-xml.md)
######## [Procedura: Recuperare il valore superficiale di un elemento](csharp/programming-guide/concepts/linq/how-to-retrieve-the-shallow-value-of-an-element.md)
####### [Esecuzione di query su strutture ad albero XML](csharp/programming-guide/concepts/linq/querying-xml-trees.md)
######## [Query di base (LINQ to XML)](csharp/programming-guide/concepts/linq/basic-queries-linq-to-xml.md)
######### [Procedura: Trovare un elemento con un attributo specifico](csharp/programming-guide/concepts/linq/how-to-find-an-element-with-a-specific-attribute.md)
######### [Procedura: Trovare un elemento con un elemento figlio specifico](csharp/programming-guide/concepts/linq/how-to-find-an-element-with-a-specific-child-element.md)
######### [Esecuzione di query su XDocument e su XElement](csharp/programming-guide/concepts/linq/querying-an-xdocument-vs-querying-an-xelement.md)
######### [Procedura: Trovare discendenti con un nome di elemento specifico](csharp/programming-guide/concepts/linq/how-to-find-descendants-with-a-specific-element-name.md)
######### [Procedura: Trovare un singolo discendente usando il metodo Descendants](csharp/programming-guide/concepts/linq/how-to-find-a-single-descendant-using-the-descendants-method.md)
######### [Procedura: Scrivere query con filtri complessi](csharp/programming-guide/concepts/linq/how-to-write-queries-with-complex-filtering.md)
######### [Procedura: Applicare un filtro in base a un elemento facoltativo](csharp/programming-guide/concepts/linq/how-to-filter-on-an-optional-element.md)
######### [Procedura: Trovare tutti i nodi in uno spazio dei nomi](csharp/programming-guide/concepts/linq/how-to-find-all-nodes-in-a-namespace.md)
######### [Procedura: Ordinare elementi](csharp/programming-guide/concepts/linq/how-to-sort-elements.md)
######### [Procedura: Ordinare elementi su più chiavi](csharp/programming-guide/concepts/linq/how-to-sort-elements-on-multiple-keys.md)
######### [Procedura: Calcolare valori intermedi](csharp/programming-guide/concepts/linq/how-to-calculate-intermediate-values.md)
######### [Procedura: Scrivere una query per trovare elementi in base al contesto](csharp/programming-guide/concepts/linq/how-to-write-a-query-that-finds-elements-based-on-context.md)
######### [Procedura: Eseguire il debug di set di risultati di query vuote](csharp/programming-guide/concepts/linq/how-to-debug-empty-query-results-sets.md)
######## [Proiezioni e trasformazioni (LINQ to XML)](csharp/programming-guide/concepts/linq/projections-and-transformations-linq-to-xml.md)
######### [Procedura: Usare i dizionari con LINQ to XML](csharp/programming-guide/concepts/linq/how-to-work-with-dictionaries-using-linq-to-xml.md)
######### [Procedura: Trasformare la forma di un albero XML](csharp/programming-guide/concepts/linq/how-to-transform-the-shape-of-an-xml-tree.md)
######### [Procedura: Controllare il tipo di una proiezione](csharp/programming-guide/concepts/linq/how-to-control-the-type-of-a-projection.md)
######### [Procedura: Proiettare un nuovo tipo (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-project-a-new-type-linq-to-xml.md)
######### [Procedura: Proiettare un oggetto grafico](csharp/programming-guide/concepts/linq/how-to-project-an-object-graph.md)
######### [Procedura: Proiettare un tipo anonimo](csharp/programming-guide/concepts/linq/how-to-project-an-anonymous-type.md)
######### [Procedura: Generare file di testo da codice XML](csharp/programming-guide/concepts/linq/how-to-generate-text-files-from-xml.md)
######### [Procedura: Generare codice XML da file CSV](csharp/programming-guide/concepts/linq/how-to-generate-xml-from-csv-files.md)
######## [Tecniche di query avanzate (LINQ to XML)](csharp/programming-guide/concepts/linq/advanced-query-techniques-linq-to-xml.md)
######### [Procedura: Unire due raccolte con join (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-join-two-collections-linq-to-xml.md)
######### [Procedura: Creare una gerarchia usando il raggruppamento](csharp/programming-guide/concepts/linq/how-to-create-hierarchy-using-grouping.md)
######### [Procedura: Eseguire query su LINQ to XML con XPath](csharp/programming-guide/concepts/linq/how-to-query-linq-to-xml-using-xpath.md)
######### [Procedura: Scrivere un metodo dell'asse LINQ to XML](csharp/programming-guide/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)
######### [Procedura: Eseguire trasformazioni del testo in streaming su XML](csharp/programming-guide/concepts/linq/how-to-perform-streaming-transformations-of-text-to-xml.md)
######### [Procedura: Elencare tutti i nodi in un albero](csharp/programming-guide/concepts/linq/how-to-list-all-nodes-in-a-tree.md)
######### [Procedura: Recuperare paragrafi da un documento Office Open XML](csharp/programming-guide/concepts/linq/how-to-retrieve-paragraphs-from-an-office-open-xml-document.md)
######### [Procedura: Modificare un documento Office Open XML](csharp/programming-guide/concepts/linq/how-to-modify-an-office-open-xml-document.md)
######### [Procedura: Popolare un albero XML dal file system](csharp/programming-guide/concepts/linq/how-to-populate-an-xml-tree-from-the-file-system.md)
######## [LINQ to XML per utenti di XPath](csharp/programming-guide/concepts/linq/linq-to-xml-for-xpath-users.md)
######### [Confronto tra XPath e LINQ to XML](csharp/programming-guide/concepts/linq/comparison-of-xpath-and-linq-to-xml.md)
######### [Procedura: Trovare un elemento figlio (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-child-element-xpath-linq-to-xml.md)
######### [Procedura: Trovare un elenco di elementi figlio (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-list-of-child-elements-xpath-linq-to-xml.md)
######### [Procedura: Trovare l'elemento radice (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-the-root-element-xpath-linq-to-xml.md)
######### [Procedura: Trovare elementi discendenti (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-descendant-elements-xpath-linq-to-xml.md)
######### [Procedura: Applicare un filtro a un attributo (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-filter-on-an-attribute-xpath-linq-to-xml.md)
######### [Procedura: Applicare un filtro in base a un attributo (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-related-elements-xpath-linq-to-xml.md)
######### [Procedura: Trovare elementi in uno sazio dei nomi (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-elements-in-a-namespace-xpath-linq-to-xml.md)
######### [Procedura: Trovare elementi di pari livello immediatamente precedenti (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md)
######### [Procedura: Trovare discendenti di un elemento figlio (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-descendants-of-a-child-element-xpath-linq-to-xml.md)
######### [Procedura: Trovare un'unione di due percorsi di posizione (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-union-of-two-location-paths-xpath-linq-to-xml.md)
######### [Procedura: trovare nodi di pari livello (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-sibling-nodes-xpath-linq-to-xml.md)
######### [Procedura: Trovare un attributo dell'elemento padre (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-an-attribute-of-the-parent-xpath-linq-to-xml.md)
######### [Procedura: Trovare attributi di elementi di pari livello con un nome specifico (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-attributes-of-siblings-with-a-specific-name-xpath-linq-to-xml.md)
######### [Procedura: Trovare elementi con un attributo specifico (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-elements-with-a-specific-attribute-xpath-linq-to-xml.md)
######### [Procedura: Trovare elementi figlio in base alla posizione (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-child-elements-based-on-position-xpath-linq-to-xml.md)
######### [Procedura: Trovare l'elemento di pari livello immediatamente precedente (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-the-immediate-preceding-sibling-xpath-linq-to-xml.md)
######## [Trasformazioni funzionali pure di XML](csharp/programming-guide/concepts/linq/pure-functional-transformations-of-xml.md)
######### [Introduzione alle trasformazioni funzionali pure](csharp/programming-guide/concepts/linq/introduction-to-pure-functional-transformations.md)
########## [Concetti e terminologia (trasformazione funzionale)](csharp/programming-guide/concepts/linq/concepts-and-terminology-functional-transformation.md)
########## [Differenze tra programmazione funzionale e programmazione imperativa](csharp/programming-guide/concepts/linq/functional-programming-vs-imperative-programming.md)
########## [Refactoring in funzioni pure](csharp/programming-guide/concepts/linq/refactoring-into-pure-functions.md)
########## [Applicabilità della trasformazione funzionale](csharp/programming-guide/concepts/linq/applicability-of-functional-transformation.md)
########## [Trasformazione funzionale di XML](csharp/programming-guide/concepts/linq/functional-transformation-of-xml.md)
######### [Esercitazione: Concatenamento di query](csharp/programming-guide/concepts/linq/tutorial-chaining-queries-together.md)
########## [Esecuzione posticipata e valutazione lazy in LINQ to XML](csharp/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)
########## [Esempio di esecuzione posticipata](csharp/programming-guide/concepts/linq/deferred-execution-example.md)
########## [Esempio di concatenamento di query](csharp/programming-guide/concepts/linq/chaining-queries-example.md)
########## [Materializzazione intermedia](csharp/programming-guide/concepts/linq/intermediate-materialization.md)
########## [Concatenamento di operatori di query standard](csharp/programming-guide/concepts/linq/chaining-standard-query-operators-together.md)
######### [Esercitazione: Modifica di contenuto in un documento WordprocessingML](csharp/programming-guide/concepts/linq/tutorial-manipulating-content-in-a-wordprocessingml-document.md)
########## [Forma dei documenti WordprocessingML](csharp/programming-guide/concepts/linq/shape-of-wordprocessingml-documents.md)
########## [Creazione del documento Office Open XML di origine](csharp/programming-guide/concepts/linq/creating-the-source-office-open-xml-document.md)
########## [Individuazione dello stile del paragrafo predefinito](csharp/programming-guide/concepts/linq/finding-the-default-paragraph-style.md)
########## [Recupero dei paragrafi e dei relativi stili](csharp/programming-guide/concepts/linq/retrieving-the-paragraphs-and-their-styles.md)
########## [Recupero del testo dei paragrafi](csharp/programming-guide/concepts/linq/retrieving-the-text-of-the-paragraphs.md)
########## [Uso di un metodo di estensione per il refactoring](csharp/programming-guide/concepts/linq/refactoring-using-an-extension-method.md)
########## [Refactoring con una funzione pure](csharp/programming-guide/concepts/linq/refactoring-using-a-pure-function.md)
########## [Proiezione di codice XML in una forma diversa](csharp/programming-guide/concepts/linq/projecting-xml-in-a-different-shape.md)
########## [Ricerca di testo in documenti di Word](csharp/programming-guide/concepts/linq/finding-text-in-word-documents.md)
########## [Dettagli sui documenti WordprocessingML di Office Open XML](csharp/programming-guide/concepts/linq/details-of-office-open-xml-wordprocessingml-documents.md)
########### [Documento WordprocessingML con stili](csharp/programming-guide/concepts/linq/wordprocessingml-document-with-styles.md)
########### [Parte di stile di un documento WordprocessingML](csharp/programming-guide/concepts/linq/style-part-of-a-wordprocessingml-document.md)
########### [Esempio che restituisce come output parti di un documento Office Open XML](csharp/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)
####### [Modifica di alberi XML (LINQ to XML)](csharp/programming-guide/concepts/linq/modifying-xml-trees-linq-to-xml.md)
######## [Differenze tra la modifica dell'albero XML in memoria e la costruzione funzionale (LINQ to XML)](csharp/programming-guide/concepts/linq/in-memory-xml-tree-modification-vs-functional-construction-linq-to-xml.md)
######## [Aggiunta di elementi, attributi e nodi a un albero XML](csharp/programming-guide/concepts/linq/adding-elements-attributes-and-nodes-to-an-xml-tree.md)
######## [Modifica di elementi, attributi e nodi in un albero XML](csharp/programming-guide/concepts/linq/modifying-elements-attributes-and-nodes-in-an-xml-tree.md)
######## [Rimozione di elementi, attributi e nodi da un albero XML](csharp/programming-guide/concepts/linq/removing-elements-attributes-and-nodes-from-an-xml-tree.md)
######## [Gestione di coppie nome/valore](csharp/programming-guide/concepts/linq/maintaining-name-value-pairs.md)
######## [Procedura: Cambiare lo spazio dei nomi per un intero albero XML](csharp/programming-guide/concepts/linq/how-to-change-the-namespace-for-an-entire-xml-tree.md)
####### [Prestazioni (LINQ to XML)](csharp/programming-guide/concepts/linq/performance-linq-to-xml.md)
######## [Prestazioni delle query concatenate (LINQ to XML)](csharp/programming-guide/concepts/linq/performance-of-chained-queries-linq-to-xml.md)
######## [Oggetti XName e XNamespace atomizzati (LINQ to XML)](csharp/programming-guide/concepts/linq/atomized-xname-and-xnamespace-objects-linq-to-xml.md)
######## [Pre-atomizzazione di oggetti XName (LINQ to XML)](csharp/programming-guide/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)
######## [Query compilate in modo statico (LINQ to XML)](csharp/programming-guide/concepts/linq/statically-compiled-queries-linq-to-xml.md)
####### [Programmazione LINQ to XML avanzata](csharp/programming-guide/concepts/linq/advanced-linq-to-xml-programming.md)
######## [Annotazioni in LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-annotations.md)
######## [Eventi LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-events.md)
######## [Programmazione con i nodi](csharp/programming-guide/concepts/linq/programming-with-nodes.md)
######## [Bug derivanti dall'uso combinato di codice dichiarativo/codice imperativo (LINQ to XML)](csharp/programming-guide/concepts/linq/mixed-declarative-code-imperative-code-bugs-linq-to-xml.md)
######## [Procedura: Generare un flusso di frammenti XML con accesso a informazioni di intestazione](csharp/programming-guide/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)
######## [Procedura: Eseguire una trasformazione di flusso di documenti XML di grandi dimensioni](csharp/programming-guide/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)
######## [Procedura: Leggere e scrivere un documento codificato](csharp/programming-guide/concepts/linq/how-to-read-and-write-an-encoded-document.md)
######## [Uso di XSLT per trasformare un albero XML](csharp/programming-guide/concepts/linq/using-xslt-to-transform-an-xml-tree.md)
######## [Procedura: Usare annotazioni per trasformare alberi LINQ to XML in uno stile XSLT](csharp/programming-guide/concepts/linq/how-to-use-annotations-to-transform-linq-to-xml-trees-in-an-xslt-style.md)
######## [Serializzazione di oggetti grafici contenenti oggetti XElement](csharp/programming-guide/concepts/linq/serializing-object-graphs-that-contain-xelement-objects.md)
######### [Procedura: Eseguire la serializzazione con XmlSerializer](csharp/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)
######### [Procedura: Eseguire la serializzazione con DataContractSerializer](csharp/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)
####### [Sicurezza in LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-security.md)
####### [Documenti XML di esempio (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-documents-linq-to-xml.md)
######## [File XML di esempio: Typical Purchase Order (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml-1.md)
######## [File XML di esempio: Typical Purchase Order in a Namespace](csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)
######## [File XML di esempio: Multiple Purchase Orders (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md)
######## [File XML di esempio: Multiple Purchase Orders in a Namespace](csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-in-a-namespace.md)
######## [File XML di esempio: Test Configuration (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-linq-to-xml.md)
######## [File XML di esempio: Test Configuration in a Namespace](csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-in-a-namespace1.md)
######## [File XML di esempio: Customers and Orders (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-linq-to-xml-2.md)
######## [File XSD di esempio: Customers and Orders](csharp/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders1.md)
######## [File XML di esempio: Customers and Orders in a Namespace](csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)
######## [File XML di esempio: Numerical Data (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-linq-to-xml.md)
######## [File XML di esempio: Numerical Data in a Namespace](csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-in-a-namespace.md)
######## [File XML di esempio: Books (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-books-linq-to-xml.md)
######## [File XML di esempio: Consolidated Purchase Orders](csharp/programming-guide/concepts/linq/sample-xml-file-consolidated-purchase-orders.md)
###### [Riferimenti (LINQ to XML)](csharp/programming-guide/concepts/linq/reference-linq-to-xml.md)
##### [LINQ to ADO.NET (pagina portale)](csharp/programming-guide/concepts/linq/linq-to-adonet-portal-page.md)
##### [Abilitazione di un'origine dati per l'esecuzione di query LINQ](csharp/programming-guide/concepts/linq/enabling-a-data-source-for-linq-querying1.md)
##### [Supporto degli strumenti e IDE di Visual Studio per LINQ](csharp/programming-guide/concepts/linq/visual-studio-ide-and-tools-support-for-linq.md)
#### [Programmazione orientata ad oggetti](csharp/programming-guide/concepts/object-oriented-programming.md)
...
##### [Procedura: Scrivere dati oggetto in un file XML](csharp/programming-guide/concepts/serialization/how-to-write-object-data-to-an-xml-file.md)
##### [Procedura: Leggere dati oggetto in un file XML](csharp/programming-guide/concepts/serialization/how-to-read-object-data-from-an-xml-file.md)
##### [Procedura dettagliata: Persistenza di un oggetto in Visual Studio](csharp/programming-guide/concepts/serialization/walkthrough-persisting-an-object-in-visual-studio.md)
#### [Threading](csharp/programming-guide/concepts/threading/index.md)
##### [Applicazioni multithread](csharp/programming-guide/concepts/threading/multithreaded-applications.md)
##### [Parametri e valori restituiti per routine multithreading](csharp/programming-guide/concepts/threading/parameters-and-return-values-for-multithreaded-procedures.md)
##### [Procedura dettagliata: Multithreading con il componente BackgroundWorker](csharp/programming-guide/concepts/threading/walkthrough-multithreading-with-the-backgroundworker-component.md)
##### [Sincronizzazione di thread](csharp/programming-guide/concepts/threading/thread-synchronization.md)
##### [Timer di thread](csharp/programming-guide/concepts/threading/thread-timers.md)
##### [Pooling dei thread](csharp/programming-guide/concepts/threading/thread-pooling.md)
###### [Procedura: Usare un pool di thread](csharp/programming-guide/concepts/threading/how-to-use-a-thread-pool.md)
...
###### [Procedura: Usare espressioni lambda in una query](csharp/programming-guide/statements-expressions-operators/how-to-use-lambda-expressions-in-a-query.md)
###### [Procedura: Usare espressioni lambda all'esterno di LINQ](csharp/programming-guide/statements-expressions-operators/how-to-use-lambda-expressions-outside-linq.md)
...
##### [Procedura: Definire l'uguaglianza di valori per un tipo](csharp/programming-guide/statements-expressions-operators/how-to-define-value-equality-for-a-type.md)
##### [Procedura: Testare l'uguaglianza dei riferimenti (identità)](csharp/programming-guide/statements-expressions-operators/how-to-test-for-reference-equality-identity.md)
### [Stringhe](csharp/programming-guide/strings/index.md)
#### [Procedura: Concatenare più stringhe](csharp/programming-guide/strings/how-to-concatenate-multiple-strings.md)
#### [Procedura: Modificare il contenuto delle stringhe](csharp/programming-guide/strings/how-to-modify-string-contents.md)
#### [Procedura: Confrontare stringhe](csharp/programming-guide/strings/how-to-compare-strings.md)
#### [Procedura: Analizzare le stringhe con String.Split](csharp/programming-guide/strings/how-to-parse-strings-using-string-split.md)
#### [Procedura: Eseguire la ricerca di stringhe usando metodi stringa](csharp/programming-guide/strings/how-to-search-strings-using-string-methods.md)
#### [Procedura: Eseguire la ricerca di stringhe usando espressioni regolari](csharp/programming-guide/strings/how-to-search-strings-using-regular-expressions.md)
...
#### [Procedura: Convertire una stringa in un oggetto DateTime](csharp/programming-guide/strings/how-to-convert-a-string-to-a-datetime.md)
#### [Procedura: eseguire la conversione tra codifiche legacy e Unicode](csharp/programming-guide/strings/how-to-convert-between-legacy-encodings-and-unicode.md)
#### [Procedura: Convertire il formato RTF in testo normale](csharp/programming-guide/strings/how-to-convert-rtf-to-plain-text.md)
...
##### [Procedura dettagliata: Creazione e uso di oggetti dinamici (C# e Visual Basic)](csharp/programming-guide/types/walkthrough-creating-and-using-dynamic-objects.md)
...
###### [Procedura: Recuperare il valore di una variabile puntatore](csharp/programming-guide/unsafe-code-pointers/how-to-obtain-the-value-of-a-pointer-variable.md)
###### [Procedura: Ottenere l'indirizzo di una variabile](csharp/programming-guide/unsafe-code-pointers/how-to-obtain-the-address-of-a-variable.md)
...
####### [Procedura: Incrementare e decrementare i puntatori](csharp/programming-guide/unsafe-code-pointers/how-to-increment-and-decrement-pointers.md)
####### [Operazioni aritmetiche con i puntatori](csharp/programming-guide/unsafe-code-pointers/arithmetic-operations-on-pointers.md)
####### [Confronto tra puntatori](csharp/programming-guide/unsafe-code-pointers/pointer-comparison.md)
...
##### [Attributo cref](csharp/programming-guide/xmldoc/cref-attribute.md)
...
###### [Stringhe interpolate (riferimenti di C# e Visual Basic)](csharp/language-reference/keywords/interpolated-strings.md)
...
##### [in (modificatore generico)](csharp/language-reference/keywords/in-generic-modifier.md)
##### [out (modificatore generico)](csharp/language-reference/keywords/out-generic-modifier.md)
...
##### [Istruzioni di selezione](csharp/language-reference/keywords/selection-statements.md)
...
##### [nameof (Riferimenti di C# e Visual Basic)](csharp/language-reference/keywords/nameof.md)
#### [Parole chiave per la conversione](csharp/language-reference/keywords/conversion-keywords.md)
...
#### [Parole chiave contestuali](csharp/language-reference/keywords/contextual-keywords.md)
...
##### [partial (metodo)](csharp/language-reference/keywords/partial-method.md)
##### [remove](csharp/language-reference/keywords/remove.md)
##### [set](csharp/language-reference/keywords/set.md)
##### [where (vincolo di tipo generico)](csharp/language-reference/keywords/where-generic-type-constraint.md)
##### [value](csharp/language-reference/keywords/value.md)
##### [yield](csharp/language-reference/keywords/yield.md)
#### [Parole chiave per le query](csharp/language-reference/keywords/query-keywords.md)
...
##### [Clausola let](csharp/language-reference/keywords/let-clause.md)
...
#### [Operatore1](csharp/language-reference/operators/index-operator.md)
...
#### [Operatore +](csharp/language-reference/operators/addition-operator.md)
#### [Operatore2 -](csharp/language-reference/operators/subtraction-operator.md)
#### [Operatore *](csharp/language-reference/operators/multiplication-operator.md)
#### [Operatore1 -](csharp/language-reference/operators/division-operator.md)
#### [Operatore %](csharp/language-reference/operators/modulus-operator.md)
#### [Operatore &](csharp/language-reference/operators/and-operator.md)
#### [Operatore |](csharp/language-reference/operators/or-operator.md)
#### [Operatore ^](csharp/language-reference/operators/xor-operator.md)
#### [! (operatore)](csharp/language-reference/operators/logical-negation-operator.md)
#### [Operatore ~](csharp/language-reference/operators/bitwise-complement-operator.md)
#### [Operatore =](csharp/language-reference/operators/assignment-operator.md)
#### [Operatore <](csharp/language-reference/operators/less-than-operator.md)
#### [Operatore >](csharp/language-reference/operators/greater-than-operator.md)
#### [Operatore ?:](csharp/language-reference/operators/conditional-operator.md)
#### [Operatore ++](csharp/language-reference/operators/increment-operator.md)
#### [Operatore --](csharp/language-reference/operators/decrement-operator.md)
#### [Operatore &&](csharp/language-reference/operators/conditional-and-operator.md)
#### [Operatore ||](csharp/language-reference/operators/conditional-or-operator.md)
#### [Operatore <<](csharp/language-reference/operators/left-shift-operator.md)
#### [Operatore >>](csharp/language-reference/operators/right-shift-operator.md)
#### [Operatore ==](csharp/language-reference/operators/equality-comparison-operator.md)
#### [Operatore !=](csharp/language-reference/operators/not-equal-operator.md)
#### [Operatore <=](csharp/language-reference/operators/less-than-equal-operator.md)
#### [Operatore >=](csharp/language-reference/operators/greater-than-equal-operator.md)
#### [Operatore +=](csharp/language-reference/operators/addition-assignment-operator.md)
#### [Operatore2 -=](csharp/language-reference/operators/subtraction-assignment-operator-1.md)
#### [Operatore *=](csharp/language-reference/operators/multiplication-assignment-operator.md)
#### [Operatore1 -=](csharp/language-reference/operators/subtraction-assignment-operator.md)
#### [Operatore %=](csharp/language-reference/operators/modulus-assignment-operator.md)
#### [Operatore &=](csharp/language-reference/operators/and-assignment-operator.md)
#### [Operatore |=](csharp/language-reference/operators/or-assignment-operator.md)
#### [Operatore ^=](csharp/language-reference/operators/xor-assignment-operator.md)
#### [Operatore <<=](csharp/language-reference/operators/left-shift-assignment-operator.md)
#### [Operatore >>=](csharp/language-reference/operators/right-shift-assignment-operator.md)
#### [Operatore ->](csharp/language-reference/operators/dereference-operator.md)
#### [?? (operatore)](csharp/language-reference/operators/null-conditional-operator.md)
#### [Operatore =>](csharp/language-reference/operators/lambda-operator.md)
#### [Operatori condizionali null (C# e Visual Basic)](csharp/language-reference/operators/null-conditional-operators.md)
...
##### [@Opzioni del compilatore C#](csharp/language-reference/compiler-options/response-file-compiler-option.md)
##### [-addmodule (opzioni del compilatore C#)](csharp/language-reference/compiler-options/addmodule-compiler-option.md)
##### [-appconfig (opzioni del compilatore C#)](csharp/language-reference/compiler-options/appconfig-compiler-option.md)
##### [-baseaddress (opzioni del compilatore C#)](csharp/language-reference/compiler-options/baseaddress-compiler-option.md)
##### [-bugreport (opzioni del compilatore C#s)](csharp/language-reference/compiler-options/bugreport-compiler-option.md)
##### [-checked (opzioni del compilatore C#)](csharp/language-reference/compiler-options/checked-compiler-option.md)
##### [-codepage (opzioni del compilatore C#)](csharp/language-reference/compiler-options/codepage-compiler-option.md)
##### [-debug (opzioni del compilatore C#)](csharp/language-reference/compiler-options/debug-compiler-option.md)
##### [-define (opzioni del compilatore C#)](csharp/language-reference/compiler-options/define-compiler-option.md)
##### [-delaysign (opzioni del compilatore C#s)](csharp/language-reference/compiler-options/delaysign-compiler-option.md)
...
##### [-filealign (opzioni del compilatore C#)](csharp/language-reference/compiler-options/filealign-compiler-option.md)
##### [-fullpaths (opzioni del compilatore C#)](csharp/language-reference/compiler-options/fullpaths-compiler-option.md)
##### [-help, -? (opzioni del compilatore C#)](csharp/language-reference/compiler-options/help-compiler-option.md)
##### [-highentropyva (opzioni del compilatore C#)](csharp/language-reference/compiler-options/highentropyva-compiler-option.md)
##### [-keycontainer (opzioni del compilatore C#)](csharp/language-reference/compiler-options/keycontainer-compiler-option.md)
##### [-keyfile (opzioni del compilatore C#)](csharp/language-reference/compiler-options/keyfile-compiler-option.md)
##### [-langversion (opzioni del compilatore C#)](csharp/language-reference/compiler-options/langversion-compiler-option.md)
##### [-lib (opzioni del compilatore C#)](csharp/language-reference/compiler-options/lib-compiler-option.md)
##### [-link (opzioni del compilatore C#)](csharp/language-reference/compiler-options/link-compiler-option.md)
##### [-linkresource (opzioni del compilatore C#)](csharp/language-reference/compiler-options/linkresource-compiler-option.md)
##### [-main (opzioni del compilatore C#)](csharp/language-reference/compiler-options/main-compiler-option.md)
##### [-moduleassemblyname (opzioni del compilatore C#)](csharp/language-reference/compiler-options/moduleassemblyname-compiler-option.md)
##### [-noconfig (opzioni del compilatore C#)](csharp/language-reference/compiler-options/noconfig-compiler-option.md)
##### [-nologo (opzioni del compilatore C#)](csharp/language-reference/compiler-options/nologo-compiler-option.md)
##### [-nostdlib (opzioni del compilatore C#)](csharp/language-reference/compiler-options/nostdlib-compiler-option.md)
...
##### [-optimize (opzioni del compilatore C#)](csharp/language-reference/compiler-options/optimize-compiler-option.md)
##### [-out (opzioni del compilatore C#)](csharp/language-reference/compiler-options/out-compiler-option.md)
##### [-pdb (opzioni del compilatore C#)](csharp/language-reference/compiler-options/pdb-compiler-option.md)
##### [-platform (opzioni del compilatore C#)](csharp/language-reference/compiler-options/platform-compiler-option.md)
##### [-preferreduilang (opzioni del compilatore C#)](csharp/language-reference/compiler-options/preferreduilang-compiler-option.md)
##### [-recurse (opzioni del compilatore C#)](csharp/language-reference/compiler-options/recurse-compiler-option.md)
##### [-reference (opzioni del compilatore C#)](csharp/language-reference/compiler-options/reference-compiler-option.md)
##### [-resource (opzioni del compilatore C#)](csharp/language-reference/compiler-options/resource-compiler-option.md)
...
###### [-target:appcontainerexe (opzioni del compilatore C#)](csharp/language-reference/compiler-options/target-appcontainerexe-compiler-option.md)
###### [-target:exe (opzioni del compilatore C#)](csharp/language-reference/compiler-options/target-exe-compiler-option.md)
###### [-target:library (opzioni del compilatore C#)](csharp/language-reference/compiler-options/target-library-compiler-option.md)
...
###### [-target:winmdobj (opzioni del compilatore C#)](csharp/language-reference/compiler-options/target-winmdobj-compiler-option.md)
##### [-unsafe (opzioni del compilatore C#)](csharp/language-reference/compiler-options/unsafe-compiler-option.md)
##### [-utf8output (opzioni del compilatore C#)](csharp/language-reference/compiler-options/utf8output-compiler-option.md)
##### [-warn (opzioni del compilatore C#)](csharp/language-reference/compiler-options/warn-compiler-option.md)
##### [-warnaserror (opzioni del compilatore C#)](csharp/language-reference/compiler-options/warnaserror-compiler-option.md)
##### [-win32icon (opzioni del compilatore C#)](csharp/language-reference/compiler-options/win32icon-compiler-option.md)
...
#### [Errore del compilatore CS0001](csharp/language-reference/compiler-messages/cs0001.md)
#### [Errore del compilatore CS0006](csharp/language-reference/compiler-messages/cs0006.md)
#### [Errore del compilatore CS0007](csharp/language-reference/compiler-messages/cs0007.md)
#### [Errore del compilatore CS0015](csharp/language-reference/compiler-messages/cs0015.md)
#### [Errore del compilatore CS0016](csharp/language-reference/compiler-messages/cs0016.md)
#### [Errore del compilatore CS0019](csharp/language-reference/compiler-messages/cs0019.md)
#### [Errore del compilatore CS0029](csharp/language-reference/compiler-messages/cs0029.md)
#### [Errore del compilatore CS0034](csharp/language-reference/compiler-messages/cs0034.md)
#### [Errore del compilatore CS0038](csharp/language-reference/compiler-messages/cs0038.md)
#### [Errore del compilatore CS0039](csharp/language-reference/compiler-messages/cs0039.md)
#### [Errore del compilatore CS0050](csharp/language-reference/compiler-messages/cs0050.md)
#### [Errore del compilatore CS0051](csharp/language-reference/compiler-messages/cs0051.md)
#### [Errore del compilatore CS0052](csharp/language-reference/compiler-messages/cs0052.md)
#### [Errore del compilatore CS0071](csharp/language-reference/compiler-messages/cs0071.md)
#### [Errore del compilatore CS0103](csharp/language-reference/compiler-messages/cs0103.md)
#### [Errore del compilatore CS0106](csharp/language-reference/compiler-messages/cs0106.md)
#### [Errore del compilatore CS0115](csharp/language-reference/compiler-messages/cs0115.md)
#### [Errore del compilatore CS0116](csharp/language-reference/compiler-messages/cs0116.md)
#### [Errore del compilatore CS0120](csharp/language-reference/compiler-messages/cs0120.md)
#### [Errore del compilatore CS0122](csharp/language-reference/compiler-messages/cs0122.md)
#### [Errore del compilatore CS0134](csharp/language-reference/compiler-messages/cs0134.md)
#### [Errore del compilatore CS0151](csharp/language-reference/compiler-messages/cs0151.md)
#### [Errore del compilatore CS0163](csharp/language-reference/compiler-messages/cs0163.md)
#### [Errore del compilatore CS0165](csharp/language-reference/compiler-messages/cs0165.md)
#### [Errore del compilatore CS0173](csharp/language-reference/compiler-messages/cs0173.md)
#### [Errore del compilatore CS0178](csharp/language-reference/compiler-messages/cs0178.md)
#### [Errore del compilatore CS0188](csharp/language-reference/compiler-messages/cs0188.md)
#### [Errore del compilatore CS0201](csharp/language-reference/compiler-messages/cs0201.md)
#### [Errore del compilatore CS0229](csharp/language-reference/compiler-messages/cs0229.md)
#### [Errore del compilatore CS0233](csharp/language-reference/compiler-messages/cs0233.md)
#### [Errore del compilatore CS0234](csharp/language-reference/compiler-messages/cs0234.md)
#### [Errore del compilatore CS0246](csharp/language-reference/compiler-messages/cs0246.md)
#### [Errore del compilatore CS0260](csharp/language-reference/compiler-messages/cs0260.md)
#### [Errore del compilatore CS0266](csharp/language-reference/compiler-messages/cs0266.md)
#### [Errore del compilatore CS0269](csharp/language-reference/compiler-messages/cs0269.md)
#### [Errore del compilatore CS0270](csharp/language-reference/compiler-messages/cs0270.md)
#### [Errore del compilatore CS0304](csharp/language-reference/compiler-messages/cs0304.md)
#### [Errore del compilatore CS0310](csharp/language-reference/compiler-messages/cs0310.md)
#### [Errore del compilatore CS0311](csharp/language-reference/compiler-messages/cs0311.md)
#### [Errore del compilatore CS0413](csharp/language-reference/compiler-messages/cs0413.md)
#### [Errore del compilatore CS0417](csharp/language-reference/compiler-messages/cs0417.md)
#### [Errore del compilatore CS0433](csharp/language-reference/compiler-messages/cs0433.md)
#### [Errore del compilatore CS0445](csharp/language-reference/compiler-messages/cs0445.md)
#### [Errore del compilatore CS0446](csharp/language-reference/compiler-messages/cs0446.md)
#### [Errore del compilatore CS0504](csharp/language-reference/compiler-messages/cs0504.md)
#### [Errore del compilatore CS0507](csharp/language-reference/compiler-messages/cs0507.md)
#### [Errore del compilatore CS0518](csharp/language-reference/compiler-messages/cs0518.md)
#### [Errore del compilatore CS0523](csharp/language-reference/compiler-messages/cs0523.md)
#### [Errore del compilatore CS0545](csharp/language-reference/compiler-messages/cs0545.md)
#### [Errore del compilatore CS0552](csharp/language-reference/compiler-messages/cs0552.md)
#### [Errore del compilatore CS0563](csharp/language-reference/compiler-messages/cs0563.md)
#### [Errore del compilatore CS0570](csharp/language-reference/compiler-messages/cs0570.md)
#### [Errore del compilatore CS0571](csharp/language-reference/compiler-messages/cs0571.md)
#### [Errore del compilatore CS0579](csharp/language-reference/compiler-messages/cs0579.md)
#### [Errore del compilatore CS0592](csharp/language-reference/compiler-messages/cs0592.md)
#### [Errore del compilatore CS0616](csharp/language-reference/compiler-messages/cs0616.md)
#### [Errore del compilatore CS0650](csharp/language-reference/compiler-messages/cs0650.md)
#### [Errore del compilatore CS0686](csharp/language-reference/compiler-messages/cs0686.md)
#### [Errore del compilatore CS0702](csharp/language-reference/compiler-messages/cs0702.md)
#### [Errore del compilatore CS0703](csharp/language-reference/compiler-messages/cs0703.md)
#### [Errore del compilatore CS0731](csharp/language-reference/compiler-messages/cs0731.md)
#### [Errore del compilatore CS0826](csharp/language-reference/compiler-messages/cs0826.md)
#### [Errore del compilatore CS0834](csharp/language-reference/compiler-messages/cs0834.md)
#### [Errore del compilatore CS0840](csharp/language-reference/compiler-messages/cs0840.md)
#### [Errore del compilatore CS0843](csharp/language-reference/compiler-messages/cs0843.md)
#### [Errore del compilatore CS0845](csharp/language-reference/compiler-messages/cs0845.md)
#### [Errore del compilatore CS1001](csharp/language-reference/compiler-messages/cs1001.md)
#### [Errore del compilatore CS1009](csharp/language-reference/compiler-messages/cs1009.md)
#### [Errore del compilatore CS1018](csharp/language-reference/compiler-messages/cs1018.md)
#### [Errore del compilatore CS1019](csharp/language-reference/compiler-messages/cs1019.md)
#### [Errore del compilatore CS1026](csharp/language-reference/compiler-messages/cs1026.md)
#### [Errore del compilatore CS1029](csharp/language-reference/compiler-messages/cs1029.md)
#### [Errore del compilatore CS1061](csharp/language-reference/compiler-messages/cs1061.md)
#### [Errore del compilatore CS1112](csharp/language-reference/compiler-messages/cs1112.md)
#### [Errore del compilatore CS1501](csharp/language-reference/compiler-messages/cs1501.md)
#### [Errore del compilatore CS1502](csharp/language-reference/compiler-messages/cs1502.md)
#### [Errore del compilatore CS1519](csharp/language-reference/compiler-messages/cs1519.md)
#### [Errore del compilatore CS1540](csharp/language-reference/compiler-messages/cs1540.md)
#### [Errore del compilatore CS1546](csharp/language-reference/compiler-messages/cs1546.md)
#### [Errore del compilatore CS1548](csharp/language-reference/compiler-messages/cs1548.md)
#### [Errore del compilatore CS1564](csharp/language-reference/compiler-messages/cs1564.md)
#### [Errore del compilatore CS1567](csharp/language-reference/compiler-messages/cs1567.md)
#### [Errore del compilatore CS1579](csharp/language-reference/compiler-messages/cs1579.md)
#### [Errore del compilatore CS1612](csharp/language-reference/compiler-messages/cs1612.md)
#### [Errore del compilatore CS1614](csharp/language-reference/compiler-messages/cs1614.md)
#### [Errore del compilatore CS1640](csharp/language-reference/compiler-messages/cs1640.md)
#### [Errore del compilatore CS1644](csharp/language-reference/compiler-messages/cs1644.md)
#### [Errore del compilatore CS1656](csharp/language-reference/compiler-messages/cs1656.md)
#### [Errore del compilatore CS1674](csharp/language-reference/compiler-messages/cs1674.md)
#### [Errore del compilatore CS1703](csharp/language-reference/compiler-messages/cs1703.md)
#### [Errore del compilatore CS1704](csharp/language-reference/compiler-messages/cs1704.md)
#### [Errore del compilatore CS1705](csharp/language-reference/compiler-messages/cs1705.md)
#### [Errore del compilatore CS1708](csharp/language-reference/compiler-messages/cs1708.md)
#### [Errore del compilatore CS1716](csharp/language-reference/compiler-messages/cs1716.md)
#### [Errore del compilatore CS1721](csharp/language-reference/compiler-messages/cs1721.md)
#### [Errore del compilatore CS1726](csharp/language-reference/compiler-messages/cs1726.md)
#### [Errore del compilatore CS1729](csharp/language-reference/compiler-messages/cs1729.md)
#### [Errore del compilatore CS1919](csharp/language-reference/compiler-messages/cs1919.md)
#### [Errore del compilatore CS1921](csharp/language-reference/compiler-messages/cs1921.md)
#### [Errore del compilatore CS1926](csharp/language-reference/compiler-messages/cs1926.md)
#### [Errore del compilatore CS1933](csharp/language-reference/compiler-messages/cs1933.md)
#### [Errore del compilatore CS1936](csharp/language-reference/compiler-messages/cs1936.md)
#### [Errore del compilatore CS1941](csharp/language-reference/compiler-messages/cs1941.md)
#### [Errore del compilatore CS1942](csharp/language-reference/compiler-messages/cs1942.md)
#### [Errore del compilatore CS1943](csharp/language-reference/compiler-messages/cs1943.md)
#### [Errore del compilatore CS1946](csharp/language-reference/compiler-messages/cs1946.md)
#### [Errore del compilatore CS2032](csharp/language-reference/compiler-messages/cs2032.md)
#### [Avviso del compilatore (livello 1) CS0420](csharp/language-reference/compiler-messages/cs0420.md)
#### [Avviso del compilatore (livello 1) CS0465](csharp/language-reference/compiler-messages/cs0465.md)
#### [Avviso del compilatore (livello 1) CS1058](csharp/language-reference/compiler-messages/cs1058.md)
#### [Avviso del compilatore (livello 1) CS1060](csharp/language-reference/compiler-messages/cs1060.md)
#### [Avviso del compilatore (livello 1) CS1598](csharp/language-reference/compiler-messages/cs1598.md)
#### [Avviso del compilatore (livello 1) CS1607](csharp/language-reference/compiler-messages/cs1607.md)
#### [Avviso del compilatore (livello 1) CS1616](csharp/language-reference/compiler-messages/cs1616.md)
#### [Avviso del compilatore (livello 1) CS1658](csharp/language-reference/compiler-messages/cs1658.md)
#### [Avviso del compilatore (livello 1) CS1683](csharp/language-reference/compiler-messages/cs1683.md)
#### [Avviso del compilatore (livello 1) CS1685](csharp/language-reference/compiler-messages/cs1685.md)
#### [Avviso del compilatore (livello 1) CS1690](csharp/language-reference/compiler-messages/cs1690.md)
#### [Avviso del compilatore (livello 1) CS1691](csharp/language-reference/compiler-messages/cs1691.md)
#### [Avviso del compilatore (livello 1) CS1699](csharp/language-reference/compiler-messages/cs1699.md)
#### [Avviso del compilatore (livello 1) CS1762](csharp/language-reference/compiler-messages/cs1762.md)
#### [Avviso del compilatore (livello 1) CS1956](csharp/language-reference/compiler-messages/cs1956.md)
#### [Avviso del compilatore (livello 1) CS3003](csharp/language-reference/compiler-messages/cs3003.md)
#### [Avviso del compilatore (livello 1) CS3007](csharp/language-reference/compiler-messages/cs3007.md)
#### [Avviso del compilatore (livello 1) CS3009](csharp/language-reference/compiler-messages/cs3009.md)
#### [Avviso del compilatore (livello 1) CS4014](csharp/language-reference/compiler-messages/cs4014.md)
#### [Avviso del compilatore (livello 2) CS0108](csharp/language-reference/compiler-messages/cs0108.md)
#### [Avviso del compilatore (livello 2) CS0467](csharp/language-reference/compiler-messages/cs0467.md)
#### [Avviso del compilatore (livello 2) CS0618](csharp/language-reference/compiler-messages/cs0618.md)
#### [Avviso del compilatore (livello 2) CS1701](csharp/language-reference/compiler-messages/cs1701.md)
#### [Avviso del compilatore (livello 3) CS0675](csharp/language-reference/compiler-messages/cs0675.md)
#### [Avviso del compilatore (livello 3) CS1700](csharp/language-reference/compiler-messages/cs1700.md)
#### [Avviso del compilatore (livello 4) CS0429](csharp/language-reference/compiler-messages/cs0429.md)
#### [Avviso del compilatore (livello 4) CS1591](csharp/language-reference/compiler-messages/cs1591.md)
#### [Avviso del compilatore (livello 4) CS1610](csharp/language-reference/compiler-messages/cs1610.md)
