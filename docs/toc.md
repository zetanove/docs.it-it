...
## [Introduzione a .NET](standard/get-started.md)
...
## [Modelli di programmazione asincrona](standard/asynchronous-programming-patterns/)
## [Interoperabilità nativa](standard/native-interop.md)
## [Raccolte e strutture di dati](standard/collections/)
## [Dati numerici in .NET](standard/numerics.md)
## [Date, ore e fusi orari](standard/datetime/)
## [Eventi](standard/events/)
...
## [Globalizzazione e localizzazione](standard/globalization-localization/)
## [Attributi](standard/attributes/)
## [Linee guida per la progettazione di Framework](standard/design-guidelines/)
## [Documenti e dati XML](standard/data/xml/)
## [Threading](standard/threading/)
## [Programmazione parallela](standard/parallel-programming/)
## [Sicurezza](standard/security/)
## [Sviluppo per piattaforme multiple](standard/cross-platform/)
...
### [Risultati](fsharp/language-reference/results.md)
...
### [Corretto parola chiave](fsharp/language-reference/fixed.md)
...
### [Informazioni sul chiamante](fsharp/language-reference/caller-information.md)
