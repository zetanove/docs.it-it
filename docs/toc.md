...
## [Strumenti di .NET Core RC4](core/preview3/tools/index.md)
### [Panoramica delle modifiche dell'interfaccia della riga di comando](core/preview3/tools/layering.md)
### [Gestione delle dipendenze](core/preview3/tools/dependencies.md)
### [Distribuzione di applicazioni](core/preview3/deploying/index.md)
### [Aggiunte al formato csproj](core/preview3/tools/csproj.md)
### [Telemetria](core/preview3/tools/telemetry.md)
### [Modello di estendibilità](core/preview3/tools/extensibility.md)
### [Integrazione continua](core/preview3/tools/using-ci-with-cli.md)
