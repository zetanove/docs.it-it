...
|`My.WebServices`|**Sì**|**Sì**|**Sì**|**Sì**|**Sì**|**Sì**|No|No|  
 ...
 <sup>1</sup> Versione Windows Form di `My.Application`.  Deriva dalla versione console \(vedere Nota 3\). Aggiunge supporto per l'interazione con le finestre dell'applicazione e fornisce il modello applicativo di [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
