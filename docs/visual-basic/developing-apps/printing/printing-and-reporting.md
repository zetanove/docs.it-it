...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Viene illustrato come stampare un form di base utilizzando il `PrintForm` componente.  
 ...
 Vengono illustrate le opzioni disponibili per la creazione di report.
