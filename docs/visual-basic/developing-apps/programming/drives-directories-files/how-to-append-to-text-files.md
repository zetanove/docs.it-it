...
È possibile usare il metodo <xref:Microsoft.VisualBasic.FileIO.FileSystem.WriteAllText%2A> per aggiungere testo a un file di testo specificando che il parametro `append` è impostato su `True`.  
