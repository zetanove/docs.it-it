...
> [!NOTE]
>  Per informazioni sulla restituzione di un elenco di file usando la classe `DirectoryInfo` dello spazio dei nomi `System.IO` dello , vedere <xref:System.IO.DirectoryInfo.GetFiles%2A>.  
