...
È possibile usare il metodo <xref:Microsoft.VisualBasic.FileIO.FileSystem.WriteAllText%2A> per scrivere testo in file. Se il file specificato non esiste, viene creato.  
