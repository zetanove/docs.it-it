...
3.  Nella casella **Nome** digitare `FileExplorer` per impostare il nome del progetto, quindi fare clic su **OK**.  
     ...
     Il progetto verrà aggiunto a **Esplora soluzioni** in [!INCLUDE[vsprvs](../../../../csharp/includes/vsprvs-md.md)] e verrà avviato Progettazione Windows Form.  
