...
In [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] vengono forniti diversi attributi che consentono l'interoperabilità tra oggetti e codice non gestito, nonché un attributo che consente l'accesso ai membri del modulo senza il nome del modulo.  Nella tabella seguente sono elencati gli attributi utilizzati da [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
