...
4.  Assicurarsi di non aver tentato di modificare un progetto [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] in un database o un documento.  
