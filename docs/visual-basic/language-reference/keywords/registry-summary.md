...
I membri delle librerie di runtime e le parole chiave del linguaggio [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)] sono organizzati in base allo scopo e all'utilizzo.  
