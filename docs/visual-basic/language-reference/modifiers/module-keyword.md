---
title: Modulo &lt;(parola chiave)&gt; (Visual Basic) | Documenti di Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
## <a name="remarks"></a>Note  
 ...
 Il `Module` modificatore non corrisponde la [istruzione Module](../../../visual-basic/language-reference/statements/module-statement.md).  
