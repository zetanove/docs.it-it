...
Il `Microsoft.VisualBasic` spazio dei nomi contiene le classi, moduli, costanti ed enumerazioni che costituiscono il [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] della libreria di runtime. Questi membri delle librerie di forniscono procedure, le proprietà e valori costanti che è possibile utilizzare nel codice. Ogni modulo e la classe rappresenta una determinata categoria di funzionalità.  
...
## <a name="microsoftvisualbasic-constants-and-enumerations"></a>Microsoft. VisualBasic costanti ed enumerazioni  
 Il `Microsoft.VisualBasic` dello spazio dei nomi fornisce costanti ed enumerazioni come parte della [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] libreria run-time. È possibile utilizzare questi valori costanti nel codice. Ogni enumerazione rappresenta una determinata categoria di funzionalità. Per ulteriori informazioni, vedere [costanti ed enumerazioni](../../visual-basic/language-reference/constants-and-enumerations.md).  
