...
Lo spazio dei nomi `Microsoft.VisualBasic` include le classi, i moduli, le costanti e le enumerazioni che costituiscono la libreria di runtime di [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  Questi membri della libreria forniscono routine, proprietà e valori costanti che è possibile utilizzare nel codice.  Ogni modulo e classe rappresenta una determinata categoria di funzionalità.  
...
## Costanti ed enumerazioni Microsoft.VisualBasic  
 Lo spazio dei nomi `Microsoft.VisualBasic` fornisce costanti ed enumerazioni come parte della libreria di runtime di [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] È possibile utilizzare questi valori costanti nel codice.  Ogni enumerazione rappresenta una determinata categoria di funzionalità.  Per ulteriori informazioni, vedere [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).  
