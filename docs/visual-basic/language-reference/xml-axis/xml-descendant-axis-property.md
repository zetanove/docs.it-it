...
## Note  
 ...
 Il compilatore [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] converte le proprietà axis discendenti in chiamate al metodo <xref:System.Xml.Linq.XContainer.Descendants%2A>.  
