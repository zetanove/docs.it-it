...
Gli argomenti in questa sezione descrivono la sintassi dei valori letterali XML in [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  La sintassi dei valori letterali XML permettete di incorporare l'XML direttamente nel codice.  
