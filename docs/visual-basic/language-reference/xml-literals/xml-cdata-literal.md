...
> [!NOTE]
>  Un valore letterale XML può occupare più righe ma non utilizzare caratteri di continuazione di riga.  Questo permette di copiare il contenuto da un documento XML e incollarlo direttamente in un programma [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
  
 Il compilatore [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] converte il valore letterale CDATA XML in una chiamata al costruttore <xref:System.Xml.Linq.XCData.%23ctor%2A>.  
