...
Una classe derivata non dichiara un costruttore e [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] non può generarne uno perché non può chiamare alcun costruttore della classe base.  
