...
Tutti i progetti di una soluzione [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] devono avere la stessa piattaforma di destinazione, ma il progetto che si intende aggiungere ha come destinazione una piattaforma diversa da quella specificata per la soluzione.  
