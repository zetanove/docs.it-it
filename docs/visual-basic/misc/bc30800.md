...
Nelle versioni più recenti di [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] le regole relative alle chiamate di routine sono più semplici. Tutti gli argomenti devono essere racchiusi tra parentesi.  
