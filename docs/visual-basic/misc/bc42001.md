...
L'evento 'Class\_Initialize' non è più supportato. Per inizializzare una classe, utilizzare 'Sub New'.  
 ...
 L'evento `Class_Initialize` delle versioni precedenti di [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] è sostituito da costruttori di classi.  
