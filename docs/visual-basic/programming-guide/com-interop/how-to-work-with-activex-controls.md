...
I controlli ActiveX sono componenti COM o oggetti che è possibile inserire in una pagina Web o in un'altra applicazione per riutilizzare funzionalità sviluppate da altri.  È possibile utilizzare i controlli ActiveX sviluppati per Visual Basic 6.0 e versioni precedenti per aggiungere funzionalità alla **Casella degli strumenti** di [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)].  
