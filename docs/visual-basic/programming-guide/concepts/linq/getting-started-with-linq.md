...
In questa sezione sono contenuti cenni preliminari, esempi e informazioni di base utili per comprendere meglio e utilizzare Visual Basic e [!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext-md.md)].  
...
## Sezioni correlate  
 ...
 Viene inclusa una selezione di procedure relative all'utilizzo di [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)] con le raccolte in memoria.  
