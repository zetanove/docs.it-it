...
Questo argomento vengono confrontate l'asse degli elementi figlio XPath per il [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XContainer.Element%2A>(metodo).</xref:System.Xml.Linq.XContainer.Element%2A>  
