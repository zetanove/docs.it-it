...
### Esempio  
 L'esempio seguente usa la classe generica <xref:System.Collections.Generic.List%601?displayProperty=fullName> di [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort-md.md)] per creare una raccolta di oggetti `Customer`.  
