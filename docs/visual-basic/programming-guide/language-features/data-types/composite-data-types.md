...
Oltre ai tipi di dati elementari disponibili in [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], è possibile unire elementi di tipo diverso in modo da creare *tipi di dati compositi* quali strutture, matrici e classi.  È possibile compilare tipi di dati compositi utilizzando tipi di base nonché altri tipi compositi.  È ad esempio possibile definire una matrice di elementi struttura o una struttura con membri di tipo matrice.  
