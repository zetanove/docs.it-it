...
## Tipi di dati più efficaci  
 Per le variabili che non contengono mai frazioni, i tipi di dati integrali sono più efficaci di quelli non integrali.  In [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], `Integer` e `UInteger` sono i tipi numerici che offrono maggiore efficienza.  
