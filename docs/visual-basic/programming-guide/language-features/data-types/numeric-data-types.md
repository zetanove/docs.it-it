...
### Prestazioni  
 Le operazioni aritmetiche risultano più veloci con i tipi integrali che con altri tipi di dati.  In [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] le prestazioni migliori si ottengono con i tipi `Integer` e `UInteger`.  
