...
## Il carattere letterale genera un errore del compilatore  
 In assenza di caratteri di qualsiasi tipo, [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] assume i tipi di dati predefiniti come valori letterali.  Il tipo di valore letterale predefinito, racchiuso tra virgolette \(`" "`\), è `String`.  
