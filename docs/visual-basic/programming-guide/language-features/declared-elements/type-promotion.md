...
Quando si dichiara un elemento di programmazione in un modulo, [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] promuove l'ambito dell'elemento allo spazio dei nomi contenente il modulo.  Questa operazione è denominata *promozione tipo*.  
