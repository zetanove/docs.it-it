...
>  Il nome del tipo anonimo viene generato dal compilatore e può variare da una compilazione a un'altra.  Il codice non deve utilizzare o non deve basarsi sul nome di un tipo anonimo.  
 ...
 I tipi anonimi forniscono supporto critico per le query [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)].  Per ulteriori informazioni sull'utilizzo dei tipi anonimi nelle query, vedere [Anonymous Types](../../../../visual-basic/programming-guide/language-features/objects-and-classes/anonymous-types.md) e [Introduction to LINQ in Visual Basic](../../../../visual-basic/programming-guide/language-features/linq/introduction-to-linq.md).  
