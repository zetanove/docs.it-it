...
In questa sezione vengono descritti i concetti fondamentali relativi all'uso di stringhe in [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
...
## In questa sezione  
 ...
 Viene descritto come vengono utilizzate le informazioni relative alle impostazioni cultura per eseguire conversioni e confronti di stringhe in [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
