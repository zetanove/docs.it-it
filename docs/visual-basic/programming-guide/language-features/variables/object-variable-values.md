...
## Funzioni di classificazione degli oggetti  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] fornisce funzioni che restituiscono informazioni relative agli elementi a cui una variabile `Object` si riferisce, come illustrato nella tabella seguente.  
