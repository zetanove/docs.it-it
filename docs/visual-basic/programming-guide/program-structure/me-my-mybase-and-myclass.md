...
`Me`, `My`, `MyBase` e `MyClass` in [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] hanno nomi simili, ma scopi diversi.  In questo argomento viene illustrata ciascuna di queste entità per poterle distinguere.  
