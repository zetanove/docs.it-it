...
> [!NOTE]
>  L'opzione `/keyfile` non è disponibile dall'interno dell'ambiente di sviluppo di [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)], ma solo durante la compilazione dalla riga di comando.  
